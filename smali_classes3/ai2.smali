...
.method public constructor <init>(I)V
    ...
    .line 1
    invoke-static {p1}, Lai2;->a(I)Ljava/lang/String;

    move-result-object v0

    const-string/jumbo v1, "uniform mat4 uMVPMatrix;\nuniform mat4 uSTMatrix;\nuniform float uCRatio;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying highp vec2 vTextureCoord;\nvoid main() {\nvec4 scaledPos = aPosition;\nscaledPos.x = scaledPos.x * uCRatio;\ngl_Position = uMVPMatrix * scaledPos;\nvTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}\n"

    invoke-direct {p0, v1, v0}, Lci2;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(I[F[FF)V
    ...
    .line 12
    invoke-virtual {p0, p4}, Lci2;->a(Ljava/lang/String;)I
