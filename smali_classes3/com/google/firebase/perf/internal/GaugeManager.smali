...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;
    }
.end annotation
...
.field private clearcutLogger:Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;
...
.field private final pendingGaugeData:Ljava/util/concurrent/ConcurrentLinkedQueue;
...
.field private final shouldInstantiateClearcutLogger:Z
...
.method public constructor <init>(Ljava/util/concurrent/ScheduledExecutorService;Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;Lcom/google/firebase/perf/config/ConfigResolver;Lcom/google/firebase/perf/internal/GaugeMetadataManager;Lcom/google/firebase/perf/gauges/CpuGaugeCollector;Lcom/google/firebase/perf/gauges/MemoryGaugeCollector;)V
    ...
    .line 6
    invoke-direct/range {v0 .. v7}, Lcom/google/firebase/perf/internal/GaugeManager;-><init>(Ljava/util/concurrent/ScheduledExecutorService;Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;ZLcom/google/firebase/perf/config/ConfigResolver;Lcom/google/firebase/perf/internal/GaugeMetadataManager;Lcom/google/firebase/perf/gauges/CpuGaugeCollector;Lcom/google/firebase/perf/gauges/MemoryGaugeCollector;)V
...
.method public constructor <init>(Ljava/util/concurrent/ScheduledExecutorService;Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;ZLcom/google/firebase/perf/config/ConfigResolver;Lcom/google/firebase/perf/internal/GaugeMetadataManager;Lcom/google/firebase/perf/gauges/CpuGaugeCollector;Lcom/google/firebase/perf/gauges/MemoryGaugeCollector;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->pendingGaugeData:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    .line 13
    iput-object p2, p0, Lcom/google/firebase/perf/internal/GaugeManager;->clearcutLogger:Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;

    .line 14
    iput-boolean p3, p0, Lcom/google/firebase/perf/internal/GaugeManager;->shouldInstantiateClearcutLogger:Z

    .line 15
    iput-object p4, p0, Lcom/google/firebase/perf/internal/GaugeManager;->configResolver:Lcom/google/firebase/perf/config/ConfigResolver;

    .line 16
    iput-object p5, p0, Lcom/google/firebase/perf/internal/GaugeManager;->gaugeMetadataManager:Lcom/google/firebase/perf/internal/GaugeMetadataManager;

    .line 17
    iput-object p6, p0, Lcom/google/firebase/perf/internal/GaugeManager;->cpuGaugeCollector:Lcom/google/firebase/perf/gauges/CpuGaugeCollector;

    .line 18
    iput-object p7, p0, Lcom/google/firebase/perf/internal/GaugeManager;->memoryGaugeCollector:Lcom/google/firebase/perf/gauges/MemoryGaugeCollector;
    ...
    iput-object p1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->logger:Lcom/google/firebase/perf/logging/AndroidLogger;
...
.method private logOrQueueToClearcut(Lcom/google/firebase/perf/v1/GaugeMetric;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->clearcutLogger:Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;

    if-nez v0, :cond_0

    iget-boolean v1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->shouldInstantiateClearcutLogger:Z

    if-eqz v1, :cond_0

    .line 2
    invoke-static {}, Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;->getInstance()Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;

    move-result-object v0

    .line 3
    :cond_0
    iput-object v0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->clearcutLogger:Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;

    if-eqz v0, :cond_1

    .line 4
    invoke-virtual {v0, p1, p2}, Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;->log(Lcom/google/firebase/perf/v1/GaugeMetric;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V

    .line 5
    :goto_0
    iget-object p1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->pendingGaugeData:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    check-cast p1, Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;

    .line 7
    iget-object p2, p0, Lcom/google/firebase/perf/internal/GaugeManager;->clearcutLogger:Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;

    invoke-static {p1}, Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;->access$000(Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;)Lcom/google/firebase/perf/v1/GaugeMetric;

    move-result-object v0

    invoke-static {p1}, Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;->access$100(Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;)Lcom/google/firebase/perf/v1/ApplicationProcessState;

    move-result-object p1

    invoke-virtual {p2, v0, p1}, Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;->log(Lcom/google/firebase/perf/v1/GaugeMetric;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V

    goto :goto_0

    .line 8
    :cond_1
    iget-object v0, p0, Lcom/google/firebase/perf/internal/GaugeManager;->pendingGaugeData:Ljava/util/concurrent/ConcurrentLinkedQueue;

    new-instance v1, Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;

    invoke-direct {v1, p0, p1, p2}, Lcom/google/firebase/perf/internal/GaugeManager$PendingGaugeData;-><init>(Lcom/google/firebase/perf/internal/GaugeManager;Lcom/google/firebase/perf/v1/GaugeMetric;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
...
.method private startCollectingCpuMetrics(JLcom/google/firebase/perf/util/Timer;)Z
    ...
    .line 1
    iget-object p1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->logger:Lcom/google/firebase/perf/logging/AndroidLogger;

    const-string p2, "Invalid Cpu Metrics collection frequency. Did not collect Cpu Metrics."

    invoke-virtual {p1, p2}, Lcom/google/firebase/perf/logging/AndroidLogger;->d(Ljava/lang/String;)V
...
.method private syncFlush(Ljava/lang/String;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/perf/internal/GaugeManager;->logOrQueueToClearcut(Lcom/google/firebase/perf/v1/GaugeMetric;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
...
.method public setClearcutLogger(Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;)V
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation

    .line 1
    iput-object p1, p0, Lcom/google/firebase/perf/internal/GaugeManager;->clearcutLogger:Lcom/google/firebase/perf/internal/FirebasePerfClearcutLogger;
...
.method public startCollectingGauges(Lcom/google/firebase/perf/internal/PerfSession;Lcom/google/firebase/perf/v1/ApplicationProcessState;)V
    ...
    invoke-virtual {p1, p2}, Lcom/google/firebase/perf/logging/AndroidLogger;->w(Ljava/lang/String;)V
    ...
    .line 9
    iget-object p2, p0, Lcom/google/firebase/perf/internal/GaugeManager;->logger:Lcom/google/firebase/perf/logging/AndroidLogger;
    ...
    invoke-virtual {p2, p1}, Lcom/google/firebase/perf/logging/AndroidLogger;->w(Ljava/lang/String;)V
