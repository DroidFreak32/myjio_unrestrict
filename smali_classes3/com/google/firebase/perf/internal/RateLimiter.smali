.class public Lcom/google/firebase/perf/internal/RateLimiter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;
    }
.end annotation
...
.field private mNetworkLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;

.field private mTraceLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;
...
.method public constructor <init>(DJLcom/google/firebase/perf/util/Clock;FLcom/google/firebase/perf/config/ConfigResolver;)V
    ...
    .line 4
    iput-boolean v2, v0, Lcom/google/firebase/perf/internal/RateLimiter;->isLogcatEnabled:Z

    const/4 v3, 0x0

    .line 5
    iput-object v3, v0, Lcom/google/firebase/perf/internal/RateLimiter;->mTraceLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;

    .line 6
    iput-object v3, v0, Lcom/google/firebase/perf/internal/RateLimiter;->mNetworkLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;
    ...
    .line 8
    iput v1, v0, Lcom/google/firebase/perf/internal/RateLimiter;->samplingBucketId:F

    move-object/from16 v1, p7

    .line 9
    iput-object v1, v0, Lcom/google/firebase/perf/internal/RateLimiter;->configResolver:Lcom/google/firebase/perf/config/ConfigResolver;

    .line 10
    new-instance v2, Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;

    iget-boolean v12, v0, Lcom/google/firebase/perf/internal/RateLimiter;->isLogcatEnabled:Z
    ...
    invoke-direct/range {v4 .. v12}, Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;-><init>(DJLcom/google/firebase/perf/util/Clock;Lcom/google/firebase/perf/config/ConfigResolver;Ljava/lang/String;Z)V

    iput-object v2, v0, Lcom/google/firebase/perf/internal/RateLimiter;->mTraceLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;
    ...
    iput-object v2, v0, Lcom/google/firebase/perf/internal/RateLimiter;->mNetworkLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;
...
.method public constructor <init>(Landroid/content/Context;DJ)V
    ...
    invoke-static {}, Lcom/google/firebase/perf/internal/RateLimiter;->getSamplingBucketId()F
    ...
    invoke-direct/range {v0 .. v7}, Lcom/google/firebase/perf/internal/RateLimiter;-><init>(DJLcom/google/firebase/perf/util/Clock;FLcom/google/firebase/perf/config/ConfigResolver;)V
    ...
    iput-boolean p1, p0, Lcom/google/firebase/perf/internal/RateLimiter;->isLogcatEnabled:Z
...
.method private isDeviceAllowedToSendNetworkEvents()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/perf/internal/RateLimiter;->configResolver:Lcom/google/firebase/perf/config/ConfigResolver;
    ...
    .line 2
    iget v1, p0, Lcom/google/firebase/perf/internal/RateLimiter;->samplingBucketId:F
...
.method public changeRate(Z)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/perf/internal/RateLimiter;->mTraceLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;

    invoke-virtual {v0, p1}, Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;->changeRate(Z)V

    .line 2
    iget-object v0, p0, Lcom/google/firebase/perf/internal/RateLimiter;->mNetworkLimiter:Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;
...
.method public check(Lcom/google/firebase/perf/v1/PerfMetric;)Z
    ...
    .line 2
    invoke-direct {p0}, Lcom/google/firebase/perf/internal/RateLimiter;->isDeviceAllowedToSendTraces()Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/perf/internal/RateLimiter;->hasVerboseSessions(Ljava/util/List;)Z
    ...
    .line 5
    invoke-direct {p0}, Lcom/google/firebase/perf/internal/RateLimiter;->isDeviceAllowedToSendNetworkEvents()Z
    ...
    .line 7
    :cond_1
    invoke-virtual {p0, p1}, Lcom/google/firebase/perf/internal/RateLimiter;->isRateLimited(Lcom/google/firebase/perf/v1/PerfMetric;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/google/firebase/perf/internal/RateLimiter$RateLimiterImpl;->check(Lcom/google/firebase/perf/v1/PerfMetric;)Z
