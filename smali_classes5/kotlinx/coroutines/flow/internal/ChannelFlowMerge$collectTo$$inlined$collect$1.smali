...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lkotlinx/coroutines/flow/internal/ChannelFlowMerge;->collectTo(Len4;Lxp3;)Ljava/lang/Object;
.end annotation
...
.field public final synthetic $job$inlined:Lbl4;

.field public final synthetic $scope$inlined:Len4;

.field public final synthetic $semaphore$inlined:Lup4;


# direct methods
.method public constructor <init>(Lbl4;Lup4;Len4;Lkotlinx/coroutines/flow/internal/SendingCollector;)V
    .locals 0

    iput-object p1, p0, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;->$job$inlined:Lbl4;

    iput-object p2, p0, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;->$semaphore$inlined:Lup4;

    iput-object p3, p0, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;->$scope$inlined:Len4;
...
.method public emit(Ljava/lang/Object;Lxp3;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1$1;-><init>(Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;Lxp3;)V
    ...
    .line 5
    iget-object v2, p0, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;->$job$inlined:Lbl4;

    if-eqz v2, :cond_3

    invoke-static {v2}, Lel4;->b(Lbl4;)V

    .line 6
    :cond_3
    iget-object v2, p0, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;->$semaphore$inlined:Lup4;
    ...
    invoke-interface {v2, v0}, Lup4;->a(Lxp3;)Ljava/lang/Object;
    ...
    .line 7
    :goto_1
    iget-object v1, v0, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;->$scope$inlined:Len4;
    ...
    invoke-direct {v4, p1, p2, v0}, Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1$lambda$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lxp3;Lkotlinx/coroutines/flow/internal/ChannelFlowMerge$collectTo$$inlined$collect$1;)V
