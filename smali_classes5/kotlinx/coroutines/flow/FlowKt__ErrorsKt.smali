...
# direct methods
.method public static final a(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/FlowCollector;Lxp3;)Ljava/lang/Object;
    .locals 5
    ...
    invoke-direct {v0, p2}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$catchImpl$1;-><init>(Lxp3;)V
    ...
    invoke-static {p1, p0}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)Z
    ...
    invoke-static {p1, p0}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt;->a(Ljava/lang/Throwable;Lkotlin/coroutines/CoroutineContext;)Z
...
.method public static final synthetic a(Lkotlinx/coroutines/flow/Flow;ILdr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p1, p2, v1}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$retry$6;-><init>(ILdr3;Lxp3;)V

    invoke-static {p0, v0}, Lkotlinx/coroutines/flow/FlowKt;->retryWhen(Lkotlinx/coroutines/flow/Flow;Ljr3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static synthetic a(Lkotlinx/coroutines/flow/Flow;ILdr3;ILjava/lang/Object;)Lkotlinx/coroutines/flow/Flow;
    .locals 0
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lkotlinx/coroutines/flow/FlowKt;->retry(Lkotlinx/coroutines/flow/Flow;ILdr3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static final a(Lkotlinx/coroutines/flow/Flow;JLhr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p1, p2, p3, v1}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$retry$3;-><init>(JLhr3;Lxp3;)V
...
.method public static synthetic a(Lkotlinx/coroutines/flow/Flow;JLhr3;ILjava/lang/Object;)Lkotlinx/coroutines/flow/Flow;
    .locals 0
    ...
    invoke-direct {p3, p4}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$retry$1;-><init>(Lxp3;)V

    :cond_1
    invoke-static {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/FlowKt;->retry(Lkotlinx/coroutines/flow/Flow;JLhr3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static final a(Lkotlinx/coroutines/flow/Flow;Lir3;)Lkotlinx/coroutines/flow/Flow;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p1}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lir3;)V

    return-object v0
.end method

.method public static final a(Lkotlinx/coroutines/flow/Flow;Ljr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p1}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1;-><init>(Lkotlinx/coroutines/flow/Flow;Ljr3;)V

    return-object v0
.end method

.method public static final a(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/Flow;Ldr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p2, p1, v1}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt$onErrorCollect$2;-><init>(Ldr3;Lkotlinx/coroutines/flow/Flow;Lxp3;)V

    invoke-static {p0, v0}, Lkotlinx/coroutines/flow/FlowKt;->catch(Lkotlinx/coroutines/flow/Flow;Lir3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static synthetic a(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/Flow;Ldr3;ILjava/lang/Object;)Lkotlinx/coroutines/flow/Flow;
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lkotlinx/coroutines/flow/FlowKt;->onErrorCollect(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/flow/Flow;Ldr3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static final a(Ljava/lang/Throwable;Ljava/lang/Throwable;)Z
    ...
    invoke-static {p0}, Loo4;->d(Ljava/lang/Throwable;)Ljava/lang/Throwable;

    move-result-object p0

    invoke-static {p1, p0}, Lwr3;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public static final a(Ljava/lang/Throwable;Lkotlin/coroutines/CoroutineContext;)Z
    ...
    .line 17
    invoke-interface {p1}, Lbl4;->isCancelled()Z
    ...
    invoke-static {p0, p1}, Lkotlinx/coroutines/flow/FlowKt__ErrorsKt;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)Z
