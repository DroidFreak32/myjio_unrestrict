...
.method public static final a(Lkotlinx/coroutines/flow/Flow;ILhr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p2}, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapMerge$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lhr3;)V
...
.method public static synthetic a(Lkotlinx/coroutines/flow/Flow;ILhr3;ILjava/lang/Object;)Lkotlinx/coroutines/flow/Flow;
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lkotlinx/coroutines/flow/FlowKt;->flatMapMerge(Lkotlinx/coroutines/flow/Flow;ILhr3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static final a(Lkotlinx/coroutines/flow/Flow;Lhr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p1}, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapConcat$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Lhr3;)V
...
.method public static final a(Lkotlinx/coroutines/flow/Flow;Lir3;)Lkotlinx/coroutines/flow/Flow;
    ...
    const-string v0, "$this$transformLatest"
    ...
    invoke-direct/range {v1 .. v7}, Lkotlinx/coroutines/flow/internal/ChannelFlowTransformLatest;-><init>(Lir3;Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/CoroutineContext;IILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public static final b(Lkotlinx/coroutines/flow/Flow;Lhr3;)Lkotlinx/coroutines/flow/Flow;
    ...
    const-string v0, "$this$flatMapLatest"
    ...
    invoke-direct {v0, p1, v1}, Lkotlinx/coroutines/flow/FlowKt__MergeKt$flatMapLatest$1;-><init>(Lhr3;Lxp3;)V

    invoke-static {p0, v0}, Lkotlinx/coroutines/flow/FlowKt;->transformLatest(Lkotlinx/coroutines/flow/Flow;Lir3;)Lkotlinx/coroutines/flow/Flow;
...
.method public static final c(Lkotlinx/coroutines/flow/Flow;Lhr3;)Lkotlinx/coroutines/flow/Flow;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p1, v1}, Lkotlinx/coroutines/flow/FlowKt__MergeKt$mapLatest$1;-><init>(Lhr3;Lxp3;)V
