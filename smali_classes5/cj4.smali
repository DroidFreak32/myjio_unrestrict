...
.field public static final u:Lcj4;
...
.method public a(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Runnable;)V
    ...
    .line 3
    :try_start_0
    sget-object p1, Lcj4;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-virtual {p0}, Lcj4;->j()Ljava/util/concurrent/Executor;
...
.method public final a(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    .line 1
    sget-object v0, Lcj4$b;->s:Lcj4$b;
...
.method public final h()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-virtual {p0}, Lcj4;->k()I

    move-result v1

    new-instance v2, Lcj4$a;

    invoke-direct {v2, v0}, Lcj4$a;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public final i()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {p0}, Lcj4;->h()Ljava/util/concurrent/ExecutorService;
    ...
    .line 5
    sget-object v4, Lcj4;->u:Lcj4;

    invoke-virtual {v4, v0, v2}, Lcj4;->a(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
...
.method public final declared-synchronized j()Ljava/util/concurrent/Executor;
    ...
    .line 1
    :try_start_0
    sget-object v0, Lcj4;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-virtual {p0}, Lcj4;->i()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lcj4;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final k()I
    ...
    invoke-static {v0, v2}, Lbt3;->a(II)I
