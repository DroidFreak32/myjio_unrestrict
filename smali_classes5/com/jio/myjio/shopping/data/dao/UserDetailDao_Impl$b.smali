.class public Lcom/jio/myjio/shopping/data/dao/UserDetailDao_Impl$b;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/jio/myjio/shopping/data/dao/UserDetailDao_Impl;-><init>(Landroidx/room/RoomDatabase;)V
.end annotation
...
# direct methods
.method public constructor <init>(Lcom/jio/myjio/shopping/data/dao/UserDetailDao_Impl;Landroidx/room/RoomDatabase;)V
    .locals 0
...
# virtual methods
.method public a(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/jio/myjio/shopping/data/entity/UserDetails;)V
    .locals 4
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/jio/myjio/shopping/data/dao/UserDetailDao_Impl$b;->a(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/jio/myjio/shopping/data/entity/UserDetails;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `UserDetail` SET `id` = ?,`userName` = ?,`alternateEmailId` = ?,`alternateMobileNumber` = ?,`countryCode` = ?,`defaultAlertPreference` = ?,`isPrime` = ?,`primaryEmailId` = ?,`primaryMobileNumber` = ?,`title` = ?,`userType` = ? WHERE `id` = ?"
