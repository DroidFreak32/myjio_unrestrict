...
.method private uploadFileSingle(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Ljava/lang/String;Lcom/ril/jio/jiosdk/http/IHttpManager$MultipartProgressListener;Z)Ljava/lang/String;
    ...
    .line 67
    invoke-direct {v1, v7, v6}, Lcom/ril/jio/jiosdk/http/UploadHttpTasks;->sendErrorMessage(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct {v8, v6, v9, v7, v10}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V

    invoke-direct {v3, v8}, Lcom/android/volley/VolleyError;-><init>(Lcom/android/volley/NetworkResponse;)V
    ...
    .line 77
    iget-object v4, v1, Lcom/ril/jio/jiosdk/http/UploadHttpTasks;->conn:Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v3, v6, v2, v4, v5}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V

    invoke-direct {v0, v3}, Lcom/android/volley/VolleyError;-><init>(Lcom/android/volley/NetworkResponse;)V
...
.method public callFileChunkInitiate(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;ZZ)Lcom/ril/jio/jiosdk/http/result/FileUploadMetadataResult;
    ...
    .line 33
    iget-object v1, p0, Lcom/ril/jio/jiosdk/http/UploadHttpTasks;->mContext:Landroid/content/Context;
    ...
    invoke-static {v1, p3, p1}, Lcom/ril/jio/jiosdk/util/HttpUtil;->getJioServerException(Landroid/content/Context;Lcom/android/volley/VolleyError;Ljava/lang/String;)Lcom/ril/jio/jiosdk/exception/JioTejException;
...
.method public createVolleyNetworkError(ILjava/lang/String;)Lcom/android/volley/VolleyError;
    ...
    invoke-direct {v2, p1, p2, v0, v3}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V
...
.method public uploadFileChunk(Ljava/lang/String;Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Long;JLjava/lang/Long;Z)Lcom/ril/jio/jiosdk/http/result/FileUploadChunkResult;
    ...
    iget-boolean v3, v1, Lcom/ril/jio/jiosdk/http/UploadHttpTasks;->pauseUploads:Z
    ...
    .line 54
    :goto_6
    iput-boolean v12, v7, Lcom/ril/jio/jiosdk/http/result/FileUploadChunkResult;->doResume:Z
...
.method public uploadFileSingle(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Ljava/lang/String;Lcom/android/volley/Response$Listener;Lcom/android/volley/Response$ErrorListener;Lcom/ril/jio/jiosdk/http/IHttpManager$MultipartProgressListener;ZLjava/lang/String;Z)V
    .locals 6
    ...
    :goto_0
    :try_start_1
    invoke-interface {p3, p1}, Lcom/android/volley/Response$Listener;->onResponse(Ljava/lang/Object;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-interface {p4, p1}, Lcom/android/volley/Response$ErrorListener;->onErrorResponse(Lcom/android/volley/VolleyError;)V
    ...
    invoke-direct {p1, p5, p2, p3, p6}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V

    .line 10
    new-instance p2, Lcom/android/volley/VolleyError;

    invoke-direct {p2, p1}, Lcom/android/volley/VolleyError;-><init>(Lcom/android/volley/NetworkResponse;)V

    invoke-interface {p4, p2}, Lcom/android/volley/Response$ErrorListener;->onErrorResponse(Lcom/android/volley/VolleyError;)V
