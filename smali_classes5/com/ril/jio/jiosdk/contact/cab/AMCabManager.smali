...
.field private a:Lcom/ril/jio/jiosdk/contact/cab/AMCabManager$PostNetworkExecution;
...
.method private a(Lcom/ril/jio/jiosdk/contact/CABContact;)Landroid/content/ContentValues;
    ...
    const-string/jumbo v3, "server_contact_version"
...
.method private a(Landroid/os/ResultReceiver;)V
    ...
    const-string v0, "cab_next_page_url"
    ...
    .line 21
    sget-object v0, Lcom/ril/jio/jiosdk/contact/RequestType;->CAB:Lcom/ril/jio/jiosdk/contact/RequestType;

    invoke-virtual {p0}, Lcom/ril/jio/jiosdk/contact/cab/AMCabManager;->a()Lb$s1;

    move-result-object v2

    invoke-interface {p1, v0, v1, v2}, Lcom/ril/jio/jiosdk/http/IHttpManager;->amikoAsyncOperations(Lcom/ril/jio/jiosdk/contact/RequestType;Ljava/lang/String;Lb$s1;)V
    :try_end_0
...
.method private b()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string/jumbo v2, "server_contact_version"
...
.method public deleteAllContacts(Landroid/os/ResultReceiver;)V
    ...
    invoke-direct {p0}, Lcom/ril/jio/jiosdk/contact/cab/AMCabManager;->b()Lb$s1;

    move-result-object v2

    invoke-interface {p1, v1, v0, v2}, Lcom/ril/jio/jiosdk/http/IHttpManager;->amikoAsyncOperations(Lcom/ril/jio/jiosdk/contact/RequestType;Ljava/lang/String;Lb$s1;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lcom/ril/jio/jiosdk/exception/JioServerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public deleteCabData()V
    ...
    .line 9
    invoke-virtual {v2, v8}, Lcom/ril/jio/jiosdk/contact/SettingModel;->setCurrentValue(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v3}, Lcom/ril/jio/jiosdk/contact/SettingModel;->setSettingName(Ljava/lang/String;)V

    .line 13
    invoke-virtual {v5, v4}, Ljava/util/concurrent/CopyOnWriteArrayList;->indexOf(Ljava/lang/Object;)I
    ...
    .line 15
    iget-object v7, p0, Lcom/ril/jio/jiosdk/contact/cab/AMCabManager;->a:Landroid/content/Context;

    invoke-static {v7}, Lcom/ril/jio/jiosdk/contact/AMUtils;->getAccountsForSettings(Landroid/content/Context;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 21
    invoke-virtual {v9, v7}, Lcom/ril/jio/jiosdk/contact/AccountSettingsModel;->setCurrentValue(Ljava/lang/String;)V

    .line 22
    sget-object v7, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-virtual {v9, v7}, Lcom/ril/jio/jiosdk/contact/AccountSettingsModel;->setEnabled(Ljava/lang/Boolean;)V
    ...
    invoke-static {v1, v2, v3}, Lcom/ril/jio/jiosdk/contact/AMPreferences;->putString(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/ril/jio/jiosdk/contact/cab/AMCabManager;->a:Landroid/os/ResultReceiver;
