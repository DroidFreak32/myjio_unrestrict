...
.method public static getNetworkQuality(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v0, "last_chunk_time"
    ...
    .line 3
    iget-wide v2, v1, Lcom/ril/jio/jiosdk/detector/JioChunkResultSet;->a:J

    invoke-static {p0, v0, v2, v3}, Lcom/ril/jio/jiosdk/contact/AMPreferences;->putLong(Landroid/content/Context;Ljava/lang/String;J)V

    .line 4
    invoke-virtual {v1}, Lcom/ril/jio/jiosdk/detector/JioChunkResultSet;->a()Lcom/ril/jio/jiosdk/contact/ConnectionQuality;
...
.method private static isOnFreeLteSchedule(Landroid/content/Context;)Z
    .locals 7
    ...
    const-string/jumbo v3, "setting_id=? OR setting_id=? "
...
.method private static validateLteSchedules(Ljava/util/ArrayList;)Z
    .locals 9
