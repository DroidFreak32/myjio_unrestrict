...
.field private a:Lcom/ril/jio/jiosdk/contact/AMRestoreManager$DeleteRestoreContactsMapping;

.field private a:Lcom/ril/jio/jiosdk/contact/AMRestoreManager$PostNetworkExecution;

.field private a:Lcom/ril/jio/jiosdk/contact/AMRestoreManager$StartContactRestore;

.field private final a:Lcom/ril/jio/jiosdk/contact/IAMCopyManager;
...
.method private a(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/ril/jio/jiosdk/contact/AMUtils;->getRestoreState(Landroid/content/Context;)Ld;
    ...
    .line 136
    iget-object p1, v0, Ld;->a:Ljava/lang/String;
...
.method private a(Landroid/os/ResultReceiver;Ljava/util/ArrayList;)V
    ...
    invoke-static {v3}, Lcom/ril/jio/jiosdk/contact/AMUtils;->getRestoreState(Landroid/content/Context;)Ld;
...
.method private a(Landroid/os/ResultReceiver;Z)V
    ...
    const-string/jumbo v2, "restore_selected_account_id"
    ...
    invoke-virtual {p0, p1, p2}, Lcom/ril/jio/jiosdk/contact/AMRestoreManager;->a(Landroid/os/ResultReceiver;Z)Lb$s1;

    move-result-object p1

    invoke-interface {v1, v2, v0, p1}, Lcom/ril/jio/jiosdk/http/IHttpManager;->amikoAsyncOperations(Lcom/ril/jio/jiosdk/contact/RequestType;Ljava/lang/String;Lb$s1;)V
    :try_end_0
...
.method private c(Landroid/os/ResultReceiver;)V
    ...
    const-string/jumbo v4, "rollback_state"
    ...
    const-string/jumbo v2, "restore_caching_id_completed"
...
.method private f(Landroid/os/ResultReceiver;)V
    ...
    invoke-virtual {p0, p1}, Lcom/ril/jio/jiosdk/contact/AMRestoreManager;->a(Landroid/os/ResultReceiver;)Lb$s1;
...
.method private g(Landroid/os/ResultReceiver;)V
    ...
    const-string/jumbo v9, "restore_total_count"
    ...
    const-string/jumbo v13, "rollback_state"
    ...
    const-string/jumbo v11, "show_dialog"
...
.method private h(Landroid/os/ResultReceiver;)V
    ...
    .line 5
    iget-object v2, p0, Lcom/ril/jio/jiosdk/contact/AMRestoreManager;->a:Lorg/json/JSONObject;
...
.method private i(Landroid/os/ResultReceiver;)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lcom/ril/jio/jiosdk/http/IHttpManager;->amikoAsyncOperations(Lcom/ril/jio/jiosdk/contact/RequestType;Ljava/lang/String;Lb$s1;)V
    :try_end_0
...
.method public a(Landroid/os/ResultReceiver;Z)Lb$s1;
    .locals 1
...
.method public a()V
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/ril/jio/jiosdk/contact/AMUtils;->updateRestoreState(Landroid/content/Context;ILjava/lang/String;I)V
    ...
    invoke-virtual {v0, v3, v4}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V
    ...
    invoke-static {v0, v1, v2, v5}, Lcom/ril/jio/jiosdk/contact/AMUtils;->updateRestoreState(Landroid/content/Context;ILjava/lang/String;I)V
...
.method public a(Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    const-string/jumbo v3, "restore_deleted_contacts"

    const/4 v4, 0x0

    const-string/jumbo v5, "process_id"
...
.method public a(Landroid/os/ResultReceiver;)V
    ...
    const-string/jumbo v2, "restore_progress_count"
...
.method public a(Landroid/os/ResultReceiver;Ljava/lang/String;)Z
    ...
    const-string/jumbo v0, "restore_current"
...
.method public b()V
    ...
    const-string/jumbo v2, "restore_current"
    ...
    const-string/jumbo v2, "restore_total_count"
    ...
    const-string/jumbo v2, "restore_next_page_url"
    ...
    const-string/jumbo v2, "rollback_state"
    ...
    const-string/jumbo v3, "selected_snapshot"
...
.method public c()V
    ...
    const-string/jumbo v1, "restore_caching_id_completed"
...
.method public getAmikoHttpManagerResponseCallback(Lcom/ril/jio/jiosdk/contact/IAMRestoreManager$IRestoreCallback;)Lb$s1;
    .locals 1
...
.method public getAmikoHttpResponseCallback(Landroid/os/ResultReceiver;Z)Lb$s1;
    .locals 1
...
.method public getContactSnapshotList(Lcom/ril/jio/jiosdk/contact/IAMRestoreManager$IRestoreCallback;)V
    ...
    invoke-virtual {p0, p1}, Lcom/ril/jio/jiosdk/contact/AMRestoreManager;->getAmikoHttpManagerResponseCallback(Lcom/ril/jio/jiosdk/contact/IAMRestoreManager$IRestoreCallback;)Lb$s1;

    move-result-object v3

    invoke-interface {v1, v2, v0, v3}, Lcom/ril/jio/jiosdk/http/IHttpManager;->amikoAsyncOperations(Lcom/ril/jio/jiosdk/contact/RequestType;Ljava/lang/String;Lb$s1;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Lcom/ril/jio/jiosdk/exception/JioServerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public handleNetworkChange(Lcom/ril/jio/jiosdk/detector/ContactNetworkUtil$CONN_STATUS_ENUM;)V
    ...
    invoke-static {p1}, Lcom/ril/jio/jiosdk/contact/AMUtils;->getRestoreState(Landroid/content/Context;)Ld;
    ...
    const-string/jumbo v0, "rollback_state"
    ...
    const-string/jumbo v2, "selected_snapshot"
...
.method public initiateGetRestoreTime(Landroid/os/ResultReceiver;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/ril/jio/jiosdk/contact/AMRestoreManager;->getAmikoHttpResponseCallback(Landroid/os/ResultReceiver;Z)Lb$s1;
