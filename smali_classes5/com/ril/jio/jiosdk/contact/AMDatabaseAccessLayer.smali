...
.field private a:Lcom/ril/jio/jiosdk/database/DBManager;
...
.method public a(Ljava/lang/String;Lcom/ril/jio/jiosdk/contact/Contact;)Ljava/util/List;
    ...
    :sswitch_0
    const-string/jumbo v2, "sipAddress"
    ...
    const-string/jumbo v6, "vnd.android.cursor.item/relation"
...
.method public a(Lcom/ril/jio/jiosdk/contact/SettingModel;)Z
    ...
    const-string/jumbo v7, "setting_value=\'"
    ...
    const-string/jumbo v8, "setting_value"
    ...
    const-string/jumbo v9, "setting_enabled"
...
.method public b(Lcom/ril/jio/jiosdk/contact/CABContact;)Z
    ...
    const-string/jumbo v0, "server_contact_version"
    ...
    .line 26
    :try_start_b
    invoke-virtual {v2, v5, v6}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;I)V

    goto :goto_2

    .line 27
    :cond_2
    invoke-virtual {v2, v5, v1}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;I)V
    ...
    sget-object v5, Lcom/ril/jio/jiosdk/contact/AMDBConstant$RequestType;->CAB:Lcom/ril/jio/jiosdk/contact/AMDBConstant$RequestType;
    ...
    invoke-static {v5}, Lcom/ril/jio/jiosdk/util/JioUtils;->buildSectionInitial(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v2, v0, v5}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ril/jio/jiosdk/contact/AMUtils;->convertStringToMillis(Ljava/lang/String;)J

    move-result-wide v7

    invoke-virtual {v2, v0, v7, v8}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;J)V
    ...
    .line 38
    invoke-virtual {v2, v5, v0}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;I)V

    const-string v0, "has_email"

    .line 39
    invoke-virtual {v2, v0, v6}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;I)V
    :try_end_e
    ...
    const-string/jumbo v0, "simple_hash"
    ...
    invoke-direct {p0, v5}, Lcom/ril/jio/jiosdk/contact/AMDatabaseAccessLayer;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 45
    invoke-virtual {v3, v5, v6}, Lcom/ril/jio/jiosdk/contact/Contact;->setLocalDbContactId(J)V
...
.method public createMergeContactTable()V
    ...
    const-string/jumbo v1, "rank REAL, "
...
.method public declared-synchronized d(Ljava/util/concurrent/CopyOnWriteArrayList;)Z
    ...
    const-string/jumbo v3, "raw_contacts_mapping"
...
.method public deleteNativeContacts()V
    ...
    :cond_1
    const-string/jumbo v2, "raw_contacts_mapping"
...
.method public deleteNativeContactsByLuid()I
    ...
    const-string/jumbo v6, "raw_contacts_mapping"
    ...
    const-string/jumbo v6, "restore_deleted_contacts"
...
.method public declared-synchronized e(Ljava/util/concurrent/CopyOnWriteArrayList;)Z
    ...
    const-string/jumbo v14, "raw_contacts_mapping"
    ...
    const-string/jumbo v13, "server_version"
    ...
    const-string/jumbo v13, "raw_contacts_mapping"
...
.method public declared-synchronized f(Ljava/util/concurrent/CopyOnWriteArrayList;)Z
    ...
    const-string/jumbo v6, "server_guid= \'"
    ...
    const-string/jumbo v4, "server_guid"
...
.method public generateNativeTempTable()J
    ...
    invoke-virtual {v5, v8, v4}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v6, v3}, Lcom/ril/jio/jiosdk/database/InsertCommand;->insert(Ljava/lang/String;I)V
...
.method public getBackedUpContacts()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string/jumbo v6, "server_version"
    ...
    const-string/jumbo v10, "raw_contacts_mapping"
...
.method public getCabForCurrentDeviceID()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v2, v3}, Le;->getAndroid_id(Landroid/content/Context;)Ljava/lang/String;
...
.method public getParamId(Ljava/lang/String;)I
    ...
    const-string/jumbo v4, "profile_parameters"
...
.method public getRestoreListForCopy(J)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string/jumbo v5, "server_contact_version"
...
.method public initializePreferences()V
    ...
    const-string v1, "lastUserNoAdded"

    const-wide/16 v2, 0x0

    invoke-static {v0, v1, v2, v3}, Lcom/ril/jio/jiosdk/contact/AMPreferences;->putLong(Landroid/content/Context;Ljava/lang/String;J)V

    .line 2
    iget-object v0, p0, Lcom/ril/jio/jiosdk/contact/AMDatabaseAccessLayer;->a:Landroid/content/Context;

    const-string v1, "lastUserNoModified"
    ...
    const-string v1, "lastUserNoDeleted"
...
.method public declared-synchronized isContactSettingEnabled()Z
    ...
    :try_start_0
    const-string/jumbo v1, "setting_id=10"
...
.method public declared-synchronized k(Ljava/util/concurrent/CopyOnWriteArrayList;)Z
    ...
    const-string/jumbo v13, "restore_raw_contacts_mapping"
    ...
    const-string/jumbo v5, "server_version"
...
.method public populateLocalContactMappingFromNativeAndCAB(Ljava/util/concurrent/CopyOnWriteArrayList;)J
    ...
    const-string/jumbo v3, "server_version"
