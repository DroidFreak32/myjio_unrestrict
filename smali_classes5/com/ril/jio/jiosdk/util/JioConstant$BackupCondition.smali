...
# static fields
.field private static final synthetic $VALUES:[Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;
...
.method public static constructor <clinit>()V
    ...
    const-string v1, "IS_INTERNET_ERROR"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;

    const-string v3, "NEW_TRANSACTION_ID_GENERATION"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;->NEW_TRANSACTION_ID_GENERATION:Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;

    new-instance v3, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;

    const-string v5, "PROGRESS_CAN_BE_VIEWED"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;->PROGRESS_CAN_BE_VIEWED:Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;
    ...
    .line 2
    sput-object v5, Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;->$VALUES:[Lcom/ril/jio/jiosdk/util/JioConstant$BackupCondition;
