...
# static fields
.field private static final ADD_LINK_TO_BOARD_NOTIFICATION:I = 0x1f3a
...
.field private static mLocalNotificationManager:Lcom/ril/jio/jiosdk/util/LocalNotificationManager;
...
.method public static synthetic access$000()Landroidx/core/app/NotificationCompat$Builder;
    .locals 1

    .line 1
    sget-object v0, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;

    return-object v0
.end method

.method public static synthetic access$002(Landroidx/core/app/NotificationCompat$Builder;)Landroidx/core/app/NotificationCompat$Builder;
    .locals 0

    .line 1
    sput-object p0, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
...
.method private getGlideURL(Ljava/lang/String;Landroid/content/Context;)Lcom/bumptech/glide/load/model/GlideUrl;
    ...
    .line 9
    :cond_2
    invoke-static {p2}, Lcom/ril/jio/jiosdk/util/DeviceUtils;->getDeviceDetails(Landroid/content/Context;)Le;
    ...
    invoke-virtual {v2}, Le;->getClient_version()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Le;->getClient_version()Ljava/lang/String;
...
.method private static initNotificationManager(Landroid/content/Context;)V
    .locals 1
...
.method private setNotification(Lcom/ril/jio/jiosdk/Notification/JioNotification;)V
    ...
    sget-object v1, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
...
.method private setNotificationAction(Landroid/content/Intent;Lcom/ril/jio/jiosdk/Notification/JioNotification;)V
    ...
    sget-object v1, Lcom/ril/jio/jiosdk/util/LocalNotificationManager$3;->$SwitchMap$com$ril$jio$jiosdk$util$JioConstant$JioNotificationCode:[I

    iget-object v2, p2, Lcom/ril/jio/jiosdk/Notification/JioNotification;->mNotificationCode:Lcom/ril/jio/jiosdk/util/JioConstant$JioNotificationCode;
    ...
    const-string v2, "android.intent.action.OPEN_APP"

    const v3, 0x10008000

    const-string v4, "cloud://jiocloud.com/Storage"

    const-string v5, "android.intent.action.OPEN_STORAGE"

    const-string v6, "cloud://jiocloud.com/MyFiles"

    const-string v7, "com.rjil.cloud.tej.intent.BOARD_NOTIFICATION"

    const-string v8, "ACTION_NAME"

    const-string v9, "IS_FROM_ANDROID_O"
    ...
    const-string v4, "cloud://jiocloud.com/suggestedboard"
    ...
    .line 7
    invoke-virtual {p1, v9, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    .line 11
    :goto_0
    sget-object p1, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;

    invoke-virtual {p1, v12}, Landroidx/core/app/NotificationCompat$Builder;->setAutoCancel(Z)Landroidx/core/app/NotificationCompat$Builder;

    goto/16 :goto_8

    :pswitch_1
    const-string p2, "com.rjil.cloud.tej.intent.ACCOUNT_CHANGE_NOTIFICATION"
    ...
    const-string v5, "cloud://jiocloud.com"
...
.method public createBackupCompleteNotification()V
    ...
    const-string v1, "FIRST_UPLOAD_QUEUE_COMPLETE"
    ...
    sput-object v0, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    const-string v1, "cloud://jiocloud.com/mybackup"
...
.method public showAppUpgradeNotification(Z)V
    ...
    .line 22
    sget-object v2, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
...
.method public showBackupSettingChangedNotification(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/graphics/Bitmap;)V
    ...
    sput-object v1, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 6
    sget-object p2, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 20
    sget-object p3, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
...
.method public showLocalMediaNotification(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;)V
    ...
    .line 5
    sget-object p4, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p4, v0}, Landroidx/core/app/NotificationCompat$Builder;->setColor(I)Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 24
    new-instance p5, Landroidx/core/app/NotificationCompat$BigPictureStyle;

    invoke-direct {p5}, Landroidx/core/app/NotificationCompat$BigPictureStyle;-><init>()V

    invoke-virtual {p5, p4}, Landroidx/core/app/NotificationCompat$BigPictureStyle;->bigPicture(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$BigPictureStyle;

    move-result-object p4

    .line 25
    invoke-virtual {p4, p3}, Landroidx/core/app/NotificationCompat$BigPictureStyle;->setSummaryText(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$BigPictureStyle;
...
.method public showLowBatteryNotification()V
    ...
    sget v3, Lcom/ril/jio/jiosdk/R$string;->charge_battery_title_text:I
...
.method public showNotification(Landroid/content/Context;ILjava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {p4, p6}, Landroidx/core/app/NotificationCompat$Builder;->setLargeIcon(Landroid/graphics/Bitmap;)Landroidx/core/app/NotificationCompat$Builder;
...
.method public showQuotaFullNotification()V
    ...
    sget v3, Lcom/ril/jio/jiosdk/R$string;->insufficient_storage_title_text:I
    ...
    const-string v6, "android.intent.action.OPEN_REFERRAL_SECTION"
    ...
    const-string v3, "cloud://jiocloud.com/MyFiles"
    ...
    const-string v3, "IS_FROM_ANDROID_O"
    ...
    .line 12
    iget-object v3, p0, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->mContext:Landroid/content/Context;

    invoke-static {v3, v1, v0, v5}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v3, v1, v0, v5}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public showStartBackupNotification()V
    ...
    sget v3, Lcom/ril/jio/jiosdk/R$string;->start_backup_title_text:I
    ...
    .line 13
    invoke-virtual {v12, v6, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    invoke-static {v9, v1, v12, v11}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v9, v1, v12, v11}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v1

    .line 19
    :goto_0
    sget-object v9, Lcom/ril/jio/jiosdk/util/LocalNotificationManager;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
