...
.field private static sInstance:Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;
...
.method private getPendingIntent(Z)Landroid/app/PendingIntent;
    ...
    const-string v5, "cloud://jiocloud.com/MyFiles"

    const/16 v6, 0x1a

    if-eqz p1, :cond_1

    const-string p1, "android.intent.action.OPEN_FILE_TARGET"
    ...
    :cond_1
    const-string p1, "com.rjil.cloud.tej.intent.ACTION_FREE_UP_DEVICE"
    ...
    invoke-static {v0, v1, v7, p1}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v0, v1, v7, p1}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private initNotificationManager(Landroid/content/Context;)V
    ...
    .line 2
    iget-object v0, p0, Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;->mNotificationManager:Landroid/app/NotificationManager;
...
.method public cancelDeleteProgress(JJ)V
    ...
    .line 3
    sget-object v0, Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    sget-object p2, Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
...
.method public prepareWeeklyDeviceFreeNotification(Lcom/ril/jio/jiosdk/service/JioFreeupNotificationScheduler$b;)V
    ...
    const-string/jumbo v2, "shared_pref_free_mem_in_progress"
...
.method public setShowNotification(Z)V
    ...
    sput-object p1, Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    .line 5
    sget-object p1, Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;->sBuilder:Landroidx/core/app/NotificationCompat$Builder;

    invoke-virtual {p1, v2}, Landroidx/core/app/NotificationCompat$Builder;->setChannelId(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$Builder;
...
.method public updateDeleteProgress(JJ)V
    ...
    sget v2, Lcom/ril/jio/jiosdk/R$id;->cancel:I
    ...
    const-string v4, "@@@ delete percent "
    ...
    const-string v4, "Delete completed"
    ...
    sget v4, Lcom/ril/jio/jiosdk/R$id;->progress:I

    invoke-virtual {v0, v4, p2, p2, v3}, Landroid/widget/RemoteViews;->setProgressBar(IIIZ)V
    ...
    .line 12
    iput-boolean v3, p0, Lcom/ril/jio/jiosdk/util/JioDeviceFreeupNotifications;->showNotification:Z
    ...
    invoke-virtual {v0, v1, p2, p1, v3}, Landroid/widget/RemoteViews;->setProgressBar(IIIZ)V
