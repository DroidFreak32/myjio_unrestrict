...
.field private static final FREE_LTE_END_ALARM_CODE:I = 0x3f5

.field private static final FREE_LTE_START_ALARM_CODE:I = 0x3f4

.field public static final JIO_NETWORK_OPERATOR_ID:Ljava/lang/String; = "405874"

.field private static final NIGHT_TIME_LTE_JOB_ID:I = 0x15c9

.field public static final STATUS_UPDATE_REQ:I = 0x3eb

.field private static info:Ljava/util/List;
...
.field private static mSharedSettingManager:Lcom/ril/jio/jiosdk/settings/SharedSettingManager;

.field private static sProviderInfo:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private mSettingBucketStatus:I
...
.method private addAccountSettings(Landroid/content/Context;Lcom/ril/jio/jiosdk/contact/SettingModel;Lcom/ril/jio/jiosdk/settings/SharedSettingItem;)V
    ...
    const-string/jumbo v6, "setting_value"
    ...
    const-string/jumbo v5, "setting_enabled"
...
.method private fillAccountSettingsFromCursor(Ljava/util/List;Lcom/ril/jio/jiosdk/contact/SettingModel;Landroid/database/Cursor;)V
    ...
    const-string/jumbo v3, "setting_enabled"
...
.method private fillSharedSettingItemWithInfoForKitkatAbove(Landroid/content/Context;Landroid/content/pm/ResolveInfo;Lcom/ril/jio/jiosdk/settings/SharedSettingItem;)V
    ...
    const-string/jumbo p2, "setting_update"
...
.method private insertDefaultSettings(Landroid/content/Context;I)V
    ...
    const-string v5, "contact_backup_account"
    ...
    const-string/jumbo v8, "setting_type"
    ...
    invoke-direct {p0, p1, v9, v1}, Lcom/ril/jio/jiosdk/settings/SharedSettingManager;->insertQuery(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, v4, v11}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    .line 22
    sget-object v9, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->IS_NIGHT_TIME:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    invoke-virtual {v1, v8, v11}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    invoke-direct {p0, p1, v11, v1}, Lcom/ril/jio/jiosdk/settings/SharedSettingManager;->insertQuery(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 30
    sget-object v11, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->BACKUP_NETWORK_SETTING:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    .line 31
    invoke-virtual {v11}, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->getName()Ljava/lang/String;
    ...
    invoke-virtual {p2, v4, v11}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    invoke-virtual {p2, v8, v1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    const-string/jumbo v11, "setting_value"
    ...
    invoke-direct {p0, p1, v1, v6}, Lcom/ril/jio/jiosdk/settings/SharedSettingManager;->insertQuery(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-direct {p0, p1, v6, p2}, Lcom/ril/jio/jiosdk/settings/SharedSettingManager;->insertQuery(Landroid/content/Context;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 132
    sget-object v6, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->BACKUP_MESSAGES:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    .line 148
    sget-object v6, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->NO_OF_DAYS:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    .line 156
    sget-object v6, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->IS_SDK_LOGGED_IN:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    invoke-virtual {p2, v10, v0}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
...
.method private updateAppPrioritySetting(Landroid/content/Context;Lcom/ril/jio/jiosdk/system/JioUser$AppPrioritySettings;Landroid/net/Uri;Z)V
    ...
    const-string/jumbo v0, "setting_type"
    ...
    const-string/jumbo p4, "setting_name=?"

    invoke-direct {p0, p1, v0, p4, p2}, Lcom/ril/jio/jiosdk/settings/SharedSettingManager;->deleteQuery(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
...
.method private declared-synchronized updateBackupStatus(Landroid/content/Context;Lcom/ril/jio/jiosdk/autobackup/model/BackupStatus;Landroid/net/Uri;Z)V
    ...
    const-string/jumbo v2, "remaining_count"
...
.method private updateSettingsWithInfo(Landroid/content/Context;Lcom/ril/jio/jiosdk/settings/SharedSettingItem;Lcom/ril/jio/jiosdk/contact/SettingModel;ZIZ)V
    ...
    const-string/jumbo p6, "setting_id"
    ...
    const-string/jumbo p6, "setting_name"
    ...
    const-string/jumbo p6, "setting_type"
...
.method public getBackupStatus(Landroid/content/Context;)Lcom/ril/jio/jiosdk/autobackup/model/BackupStatus;
    ...
    .line 8
    iget v2, v0, Lcom/ril/jio/jiosdk/autobackup/model/BackupStatus;->photoCount:I

    iget v3, v0, Lcom/ril/jio/jiosdk/autobackup/model/BackupStatus;->videoCount:I

    add-int/2addr v2, v3

    iget v3, v0, Lcom/ril/jio/jiosdk/autobackup/model/BackupStatus;->audioCount:I

    add-int/2addr v2, v3

    add-int/2addr v2, v1

    iput v2, v0, Lcom/ril/jio/jiosdk/autobackup/model/BackupStatus;->totalFileCount:I
    ...
    const-string/jumbo v1, "remaining_count"
...
.method public initManager(Landroid/content/Context;)V
    ...
    check-cast v0, Lcom/ril/jio/jiosdk/settings/SharedSettingItem;

    iget-object v6, v0, Lcom/ril/jio/jiosdk/settings/SharedSettingItem;->contentSettingsUri:Landroid/net/Uri;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/ril/jio/jiosdk/UserInformation/LoginPrefManager;->putBoolean(Ljava/lang/String;Z)V
...
.method public updateCurrentAccountSettingsInAllPackages(Landroid/content/Context;Lcom/ril/jio/jiosdk/contact/SettingModel;)V
    ...
    const-string/jumbo v5, "setting_type"
    ...
    const-string/jumbo v6, "setting_id=?"
