...
# static fields
.field private static final d:Ljava/lang/String; = "AdvertismentsMessageHandler"

.field private static final f:Ljava/lang/String; = "eocRule"

.field private static final g:Ljava/lang/String; = "triggerType"
...
.field private h:Lcom/madme/mobile/soap/element/AdDeliveryElement;
...
.field private t:Lcom/madme/mobile/model/eocrules/rules/EocRuleDto;

.field private u:Lcom/madme/mobile/model/ad/trigger/AdTriggerType;
...
.field private x:Lcom/madme/mobile/soap/element/addelivery/ContentType;

.field private y:Lcom/madme/mobile/soap/element/addelivery/FileSpec;

.field private z:Lcom/madme/mobile/soap/element/addelivery/Quality;
...
.method private a(Ljava/lang/String;Ljava/lang/String;Lcom/madme/mobile/model/ad/trigger/AdTriggerType;)V
    ...
    :cond_4
    const-string/jumbo v0, "smsShortCodeMatch"
    ...
    :cond_5
    const-string/jumbo v0, "smsKeyword"
    ...
    :cond_6
    const-string/jumbo v0, "roamingStatus"
    ...
    :cond_b
    const-string/jumbo v0, "smsActivationText"
    ...
    :cond_c
    const-string/jumbo v0, "smsActivationNumber"
    ...
    :cond_10
    const-string/jumbo v0, "radiusInMeters"
    ...
    :cond_13
    const-string/jumbo v0, "smsShortCodeIsRegex"
    ...
    invoke-virtual {p3, p1}, Lcom/madme/mobile/model/ad/trigger/AdTriggerType;->setSmsShortCodeIsRegex(Ljava/lang/Boolean;)V

    goto :goto_0

    :cond_14
    const-string/jumbo v0, "storageUsedInPercent"
    ...
    invoke-virtual {p3, p1}, Lcom/madme/mobile/model/ad/trigger/AdTriggerType;->setStorageUsedInPercent(Ljava/lang/Integer;)V
    ...
    .line 267
    invoke-virtual {p3, p2}, Lcom/madme/mobile/model/ad/trigger/AdTriggerType;->setTime(Ljava/lang/String;)V
    ...
    invoke-virtual {p3, p1}, Lcom/madme/mobile/model/ad/trigger/AdTriggerType;->setIsLocalTime(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p3, p1}, Lcom/madme/mobile/model/ad/trigger/AdTriggerType;->setTimeWindow(Ljava/lang/Integer;)V
...
.method private a(Ljava/lang/String;Ljava/lang/String;Lcom/madme/mobile/model/eocrules/rules/EocRuleDto;)V
    ...
    const-string/jumbo v0, "ruleDialledNumber"
    ...
    :cond_0
    const-string/jumbo v0, "ruleAction"
    ...
    :cond_1
    const-string/jumbo v0, "ruleActionParam"
    ...
    :cond_2
    const-string/jumbo v0, "ruleEndDate"
    ...
    :cond_3
    const-string/jumbo v0, "ruleStartDate"
    ...
    :cond_4
    const-string/jumbo v0, "ruleRunOnce"
...
.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Z)V
    ...
    const-string/jumbo v0, "requiredApplication"
...
.method public a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 36
    invoke-virtual {v0, p2}, Lcom/madme/mobile/soap/response/AdvertismentsMessageResponse;->a(Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lcom/madme/mobile/utils/a;->a(Ljava/lang/String;)[B
    ...
    :cond_1c
    const-string/jumbo v1, "showOnSunday"
    ...
    :cond_1d
    const-string/jumbo v1, "showOnMonday"
    ...
    :cond_1e
    const-string/jumbo v1, "showOnTuesday"
    ...
    :cond_1f
    const-string/jumbo v1, "showOnWednesday"
    ...
    :cond_20
    const-string/jumbo v1, "showOnThursday"
    ...
    :cond_21
    const-string/jumbo v1, "showOnFriday"
    ...
    :cond_22
    const-string/jumbo v1, "showOnSaturday"
    ...
    :cond_25
    const-string/jumbo v1, "smsBodyMessage"
    ...
    :cond_26
    const-string/jumbo v1, "showAllDay"
    ...
    :cond_2f
    const-string/jumbo v0, "rateType"
    ...
    :cond_39
    const-string/jumbo v0, "referrerName"
    ...
    :cond_47
    const-string/jumbo v0, "reminderNotificationEnabled"
    ...
    :cond_48
    const-string/jumbo v0, "previousVersion"
    ...
    :cond_49
    const-string/jumbo v0, "showFloatingNotification"
    ...
    :cond_4a
    const-string/jumbo v0, "realTimeEnabled"
    ...
    invoke-virtual {p1, p2}, Lcom/madme/mobile/soap/element/AdDeliveryElement;->setAwaitingResources(Z)V
    ...
    :cond_51
    const-string v0, "mediaLabelText"
    ...
    invoke-virtual {p1, p2}, Lcom/madme/mobile/soap/element/AdDeliveryElement;->setMediaLabelText(Ljava/lang/String;)V

    goto :goto_0

    :cond_52
    const-string v0, "mediaLabelTextColour"
    ...
    invoke-virtual {p1, p2}, Lcom/madme/mobile/soap/element/AdDeliveryElement;->setMediaLabelTextColour(Ljava/lang/String;)V

    goto :goto_0

    :cond_53
    const-string v0, "mediaLabelTextSize"
    ...
    invoke-virtual {p1, p2}, Lcom/madme/mobile/soap/element/AdDeliveryElement;->setMediaLabelTextSize(Ljava/lang/String;)V

    goto :goto_0

    :cond_54
    const-string v0, "mediaLabelPosition"
    ...
    invoke-virtual {p1, p2}, Lcom/madme/mobile/soap/element/AdDeliveryElement;->setMediaLabelPosition(Ljava/lang/Integer;)V

    goto :goto_0

    :cond_55
    const-string v0, "deferralTimeoutSecs"
    ...
    invoke-virtual {p1, p2}, Lcom/madme/mobile/soap/element/AdDeliveryElement;->setDeferralTimeout(Ljava/lang/Long;)V
...
.method public endElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_7
    const-string/jumbo p3, "requiredApplications"
...
.method public startElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xml/sax/Attributes;)V
    ...
    .line 8
    iget-object p2, p0, Lcom/madme/mobile/soap/xmlhandler/b;->x:Lcom/madme/mobile/soap/element/addelivery/ContentType;

    iget-object p2, p2, Lcom/madme/mobile/soap/element/addelivery/ContentType;->mFileSpecs:Ljava/util/ArrayList;
    ...
    iget-object p2, p2, Lcom/madme/mobile/soap/element/addelivery/FileSpec;->mQualities:Ljava/util/ArrayList;
    ...
    :cond_11
    const-string/jumbo p1, "requiredApplications"
    ...
    :cond_12
    const-string/jumbo p1, "requiredApplication"
