...
.field private static final mwPermissions:Ljava/util/HashSet;
...
.method public getManifestDeniedPermissionsList()Ljava/util/ArrayList;
    ...
    const-string v3, "getManifestDeniedPermissionsList - looking for Android SDK = "
    ...
    .line 4
    sget-object v2, Lcom/qualcomm/ltebc/LTEBroadcastCarrierImpl;->mwPermissions:Ljava/util/HashSet;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const-string v3, "com.qualcomm.permission.USE_EMBMS_SERVICE"
    ...
    const-string v8, "getManifestDeniedPermissionsList - look for permission ; "
    ...
    invoke-virtual {v7}, Lcom/qualcomm/ltebc/LTEApplication;->getApplicationContext()Landroid/content/Context;

    move-result-object v7

    invoke-virtual {v7, v6}, Landroid/content/Context;->checkSelfPermission(Ljava/lang/String;)I
    ...
    const-string v8, "getManifestDeniedPermissionsList - permission = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v6, " (not GRANTED)"
    ...
    :cond_2
    const-string v7, "com.qualcomm.permission.USE_EMBMS_SERVICE_PLATFORM"
