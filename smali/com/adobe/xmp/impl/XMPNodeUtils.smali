...
.method public static a(Ly6;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-direct {v0, v1, p2, v2}, Ly6;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V
    ...
    invoke-direct {p2, v1, p1, v2}, Ly6;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V

    .line 3
    invoke-virtual {v0, p2}, Ly6;->c(Ly6;)V

    .line 4
    invoke-virtual {p2}, Ly6;->z()Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {p0, v0}, Ly6;->b(Ly6;)V
    ...
    .line 6
    invoke-virtual {p0, p1, v0}, Ly6;->a(ILy6;)V

    :goto_0
    return-void
.end method

.method public static b(Ly6;Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/Object;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    .line 6
    invoke-virtual {v8}, Ly6;->t()Lcom/adobe/xmp/options/PropertyOptions;
    ...
    .line 7
    invoke-virtual {v8}, Ly6;->B()Z

    move-result v9

    if-eqz v9, :cond_5

    invoke-virtual {v8, v5}, Ly6;->v(I)Ly6;
    ...
    invoke-virtual {p0, v5}, Ly6;->n(I)Ly6;
...
.method public static c(Ly6;)V
    ...
    .line 3
    invoke-virtual {v0, p0}, Ly6;->L(Ly6;)V

    goto :goto_0

    .line 4
    :cond_0
    invoke-virtual {v0, p0}, Ly6;->J(Ly6;)V
    ...
    .line 6
    invoke-virtual {v0}, Ly6;->u()Ly6;

    move-result-object p0

    invoke-virtual {p0, v0}, Ly6;->J(Ly6;)V

    :cond_1
    return-void
.end method

.method public static d(Ly6;)V
    .locals 4
    ...
    .line 4
    invoke-virtual {v2}, Ly6;->t()Lcom/adobe/xmp/options/PropertyOptions;
    ...
    .line 6
    invoke-static {p0}, Lcom/adobe/xmp/impl/XMPNodeUtils;->o(Ly6;)V

    :cond_2
    return-void
.end method

.method public static e(Ly6;Ljava/lang/String;Z)Ly6;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    invoke-direct {v0, p1, p2}, Ly6;-><init>(Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V

    .line 10
    invoke-virtual {v0, v1}, Ly6;->R(Z)V
...
.method public static f(Ly6;Ljava/lang/String;Z)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    invoke-direct {p2, v1, v0}, Ly6;-><init>(Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V

    .line 5
    invoke-virtual {p2, v2}, Ly6;->R(Z)V

    .line 6
    invoke-virtual {p0, p2}, Ly6;->b(Ly6;)V
...
.method public static g(Ly6;Lcom/adobe/xmp/impl/xpath/XMPPath;ZLcom/adobe/xmp/options/PropertyOptions;)Ly6;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    invoke-static {p0, v1, p2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->j(Ly6;Ljava/lang/String;Z)Ly6;
    ...
    .line 4
    invoke-virtual {p0, v0}, Ly6;->R(Z)V
    ...
    invoke-static {p0, v5, p2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->k(Ly6;Lcom/adobe/xmp/impl/xpath/XMPPathSegment;Z)Ly6;
    ...
    .line 7
    invoke-static {v2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->c(Ly6;)V
    ...
    invoke-virtual {p0, p1}, Ly6;->T(Lcom/adobe/xmp/options/PropertyOptions;)V
...
.method public static h(Ly6;Ljava/lang/String;Z)Ly6;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    .line 3
    invoke-virtual {v0, p1}, Ly6;->R(Z)V

    .line 4
    invoke-virtual {p0, v0}, Ly6;->c(Ly6;)V

    :cond_0
    return-object v0
.end method

.method public static i(Ly6;Ljava/lang/String;Ljava/lang/String;Z)Ly6;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    invoke-direct {v0, p1, p3}, Ly6;-><init>(Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {v0, p3}, Ly6;->V(Ljava/lang/String;)V
...
.method public static j(Ly6;Ljava/lang/String;Z)Ly6;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    .line 1
    invoke-static {p0, p1, v0, p2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->i(Ly6;Ljava/lang/String;Ljava/lang/String;Z)Ly6;
...
.method public static k(Ly6;Lcom/adobe/xmp/impl/xpath/XMPPathSegment;Z)Ly6;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    invoke-static {p0, p1, p2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->e(Ly6;Ljava/lang/String;Z)Ly6;
    ...
    invoke-static {p0, p1, p2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->h(Ly6;Ljava/lang/String;Z)Ly6;
    ...
    invoke-static {p0, p1, p2}, Lcom/adobe/xmp/impl/XMPNodeUtils;->f(Ly6;Ljava/lang/String;Z)I
    ...
    invoke-static {p1}, Lcom/adobe/xmp/impl/Utils;->h(Ljava/lang/String;)[Ljava/lang/String;
    ...
    .line 10
    invoke-static {p0, p2, p1}, Lcom/adobe/xmp/impl/XMPNodeUtils;->l(Ly6;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {p2}, Lcom/adobe/xmp/impl/Utils;->h(Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {p0, v0, p2, p1}, Lcom/adobe/xmp/impl/XMPNodeUtils;->n(Ly6;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    .line 16
    invoke-virtual {p0, p1}, Ly6;->n(I)Ly6;
...
.method public static l(Ly6;Ljava/lang/String;Ljava/lang/String;)I
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    .line 3
    invoke-virtual {v3}, Ly6;->t()Lcom/adobe/xmp/options/PropertyOptions;
    ...
    .line 5
    invoke-virtual {v3, v4}, Ly6;->n(I)Ly6;

    move-result-object v5

    .line 6
    invoke-virtual {v5}, Ly6;->s()Ljava/lang/String;
...
.method public static m(Ly6;Ljava/lang/String;)I
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    .line 3
    invoke-virtual {p0, v1}, Ly6;->n(I)Ly6;

    move-result-object v2

    .line 4
    invoke-virtual {v2}, Ly6;->B()Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v2, v0}, Ly6;->v(I)Ly6;
...
.method public static n(Ly6;Ljava/lang/String;Ljava/lang/String;I)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    .line 3
    invoke-static {p0, p1}, Lcom/adobe/xmp/impl/XMPNodeUtils;->m(Ly6;Ljava/lang/String;)I
    ...
    invoke-direct {p1, p2, p3}, Ly6;-><init>(Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V
    ...
    invoke-direct {p2, v0, v1, p3}, Ly6;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/adobe/xmp/options/PropertyOptions;)V

    .line 6
    invoke-virtual {p1, p2}, Ly6;->c(Ly6;)V

    .line 7
    invoke-virtual {p0, v2, p1}, Ly6;->a(ILy6;)V
    ...
    .line 10
    invoke-virtual {p3}, Ly6;->H()Ljava/util/Iterator;
...
.method public static o(Ly6;)V
    ...
    invoke-virtual {v2, v3}, Ly6;->v(I)Ly6;

    move-result-object v4

    invoke-virtual {v4}, Ly6;->z()Ljava/lang/String;
    ...
    .line 5
    :try_start_0
    invoke-virtual {p0, v1}, Ly6;->I(I)V

    .line 6
    invoke-virtual {p0, v3, v2}, Ly6;->a(ILy6;)V
    :try_end_0
    .catch Lcom/adobe/xmp/XMPException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static p(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 17
    invoke-static {p0}, Lcom/adobe/xmp/impl/Utils;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public static q(Ly6;Ljava/lang/Object;)V
    .locals 2

    .line 1
    invoke-static {p1}, Lcom/adobe/xmp/impl/XMPNodeUtils;->p(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Ly6;->V(Ljava/lang/String;)V
...
.method public static r(Lcom/adobe/xmp/options/PropertyOptions;Ljava/lang/Object;)Lcom/adobe/xmp/options/PropertyOptions;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
