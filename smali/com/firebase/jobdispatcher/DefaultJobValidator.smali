...
.method public static b(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public static g(Landroid/os/Bundle;)Ljava/util/List;
    ...
    .line 2
    invoke-static {p0, v2}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->f(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
...
.method public static h(Landroid/os/Bundle;)Ljava/util/List;
    ...
    .line 1
    :cond_0
    invoke-static {p0}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->d(Landroid/os/Bundle;)I
    ...
    .line 6
    invoke-static {p0}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->c(Ljava/lang/String;)Ljava/util/List;
...
.method public i(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 7
    iget-object v2, p0, Lcom/firebase/jobdispatcher/DefaultJobValidator;->a:Landroid/content/Context;
...
.method public validate(Lcom/firebase/jobdispatcher/JobParameters;)Ljava/util/List;
    ...
    invoke-static {v1, v0}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->h(Landroid/os/Bundle;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->g(Landroid/os/Bundle;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->j(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->i(Ljava/lang/String;)Ljava/util/List;

    move-result-object p1

    invoke-static {v0, p1}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
...
.method public validate(Lcom/firebase/jobdispatcher/RetryStrategy;)Ljava/util/List;
    ...
    .line 15
    invoke-static {v0, v4, v5}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->b(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 16
    invoke-static {v4, v0, v5}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->b(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 17
    invoke-static {p1, v0, v4}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->b(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 18
    invoke-static {v2, p1, v0}, Lcom/firebase/jobdispatcher/DefaultJobValidator;->b(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
