.class public Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->j()V
.end annotation
...
.method public run()V
    ...
    iget-object v0, v0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->A:Ljava/util/List;
    ...
    iget-object v2, v1, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->A:Ljava/util/List;
    ...
    iput-object v2, v1, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->B:Landroid/content/Intent;
    ...
    iget-object v0, v0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->B:Landroid/content/Intent;
    ...
    iget-object v1, v1, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->B:Landroid/content/Intent;
    ...
    sget-object v4, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->D:Ljava/lang/String;
    ...
    iget-object v8, p0, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$a;->a:Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;

    iget-object v8, v8, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->B:Landroid/content/Intent;
    ...
    iget-object v7, v5, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->y:Landroidx/work/impl/background/systemalarm/CommandHandler;

    iget-object v8, v5, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->B:Landroid/content/Intent;

    invoke-virtual {v7, v8, v1, v5}, Landroidx/work/impl/background/systemalarm/CommandHandler;->o(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    :try_end_1
    ...
    invoke-direct {v1, v0}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$d;-><init>(Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V
    ...
    sget-object v5, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->D:Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {v0, v1}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->i(Ljava/lang/Runnable;)V
    ...
    invoke-direct {v2, v0}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher$d;-><init>(Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;)V

    invoke-virtual {v0, v2}, Landroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;->i(Ljava/lang/Runnable;)V
