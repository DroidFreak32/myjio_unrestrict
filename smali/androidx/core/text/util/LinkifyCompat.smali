...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v0, Landroidx/core/text/util/LinkifyCompat$a;

    invoke-direct {v0}, Landroidx/core/text/util/LinkifyCompat$a;-><init>()V
...
.method public static addLinks(Landroid/widget/TextView;Ljava/util/regex/Pattern;Ljava/lang/String;)V
    ...
    .line 26
    invoke-static {}, Landroidx/core/text/util/LinkifyCompat;->h()Z
...
.method public static addLinks(Landroid/text/Spannable;I)Z
    ...
    .line 10
    invoke-static {v1, p0}, Landroidx/core/text/util/LinkifyCompat;->e(Ljava/util/ArrayList;Landroid/text/Spannable;)V

    .line 11
    :cond_6
    invoke-static {v1, p0}, Landroidx/core/text/util/LinkifyCompat;->g(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    invoke-static {v1, v2, v0, p0}, Landroidx/core/text/util/LinkifyCompat;->b(Ljava/lang/String;IILandroid/text/Spannable;)V
...
.method public static addLinks(Landroid/text/Spannable;Ljava/util/regex/Pattern;Ljava/lang/String;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)Z
    ...
    invoke-static {p2, v2, p1, p5}, Landroidx/core/text/util/LinkifyCompat;->f(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;Landroid/text/util/Linkify$TransformFilter;)Ljava/lang/String;

    move-result-object p2

    .line 59
    invoke-static {p2, p3, v0, p0}, Landroidx/core/text/util/LinkifyCompat;->b(Ljava/lang/String;IILandroid/text/Spannable;)V
...
.method public static b(Ljava/lang/String;IILandroid/text/Spannable;)V
    .locals 1
...
.method public static c(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 3
    :cond_0
    invoke-static {p0}, Lu2;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method public static d(Ljava/util/ArrayList;Landroid/text/Spannable;Ljava/util/regex/Pattern;[Ljava/lang/String;Landroid/text/util/Linkify$MatchFilter;Landroid/text/util/Linkify$TransformFilter;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v3, p3, p2, p5}, Landroidx/core/text/util/LinkifyCompat;->f(Ljava/lang/String;[Ljava/lang/String;Ljava/util/regex/Matcher;Landroid/text/util/Linkify$TransformFilter;)Ljava/lang/String;

    move-result-object v3

    .line 8
    iput-object v3, v2, Landroidx/core/text/util/LinkifyCompat$b;->b:Ljava/lang/String;

    .line 9
    iput v0, v2, Landroidx/core/text/util/LinkifyCompat$b;->c:I

    .line 10
    iput v1, v2, Landroidx/core/text/util/LinkifyCompat$b;->d:I
...
.method public static e(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    :try_start_0
    invoke-static {p1}, Landroidx/core/text/util/LinkifyCompat;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method public static g(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v4, v3, Landroidx/core/text/util/LinkifyCompat$b;->a:Landroid/text/style/URLSpan;
    ...
    iput v4, v3, Landroidx/core/text/util/LinkifyCompat$b;->c:I
    ...
    iput v4, v3, Landroidx/core/text/util/LinkifyCompat$b;->d:I
