...
.method public static constructor <clinit>()V
    ...
    .line 5
    new-instance v0, Landroidx/core/provider/FontsContractCompat$e;

    invoke-direct {v0}, Landroidx/core/provider/FontsContractCompat$e;-><init>()V
...
.method public static c(Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static d(Landroid/content/Context;Landroidx/core/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroidx/core/provider/FontsContractCompat$FontInfo;
    .locals 20
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method public static e(Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/FontsContractCompat$f;
    .locals 3
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    .line 5
    new-instance p1, Landroidx/core/provider/FontsContractCompat$f;
    ...
    .line 6
    :cond_0
    invoke-direct {p1, p0, v2}, Landroidx/core/provider/FontsContractCompat$f;-><init>(Landroid/graphics/Typeface;I)V
    ...
    .line 8
    :cond_2
    new-instance p0, Landroidx/core/provider/FontsContractCompat$f;

    invoke-direct {p0, v0, v2}, Landroidx/core/provider/FontsContractCompat$f;-><init>(Landroid/graphics/Typeface;I)V
    ...
    invoke-direct {p0, v0, p1}, Landroidx/core/provider/FontsContractCompat$f;-><init>(Landroid/graphics/Typeface;I)V

    return-object p0
.end method

.method public static f(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V
    .locals 2
    .param p0    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    new-instance v1, Landroidx/core/provider/FontsContractCompat$d;

    invoke-direct {v1, p0, p1, v0, p2}, Landroidx/core/provider/FontsContractCompat$d;-><init>(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroid/os/Handler;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;)V
...
.method public static fetchFonts(Landroid/content/Context;Landroid/os/CancellationSignal;Landroidx/core/provider/FontRequest;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
    ...
    invoke-static {p0, p2, v0, p1}, Landroidx/core/provider/FontsContractCompat;->d(Landroid/content/Context;Landroidx/core/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroidx/core/provider/FontsContractCompat$FontInfo;
...
.method public static getFontSync(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    .line 4
    invoke-static {p0, p1, p6}, Landroidx/core/provider/FontsContractCompat;->e(Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/FontsContractCompat$f;
    ...
    .line 5
    iget p1, p0, Landroidx/core/provider/FontsContractCompat$f;->b:I

    if-nez p1, :cond_2

    .line 6
    iget-object p1, p0, Landroidx/core/provider/FontsContractCompat$f;->a:Landroid/graphics/Typeface;
    ...
    :cond_3
    :goto_0
    iget-object p0, p0, Landroidx/core/provider/FontsContractCompat$f;->a:Landroid/graphics/Typeface;

    return-object p0

    .line 9
    :cond_4
    new-instance v1, Landroidx/core/provider/FontsContractCompat$a;

    invoke-direct {v1, p0, p1, p6, v0}, Landroidx/core/provider/FontsContractCompat$a;-><init>(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/lang/String;)V
    ...
    iget-object p0, p1, Landroidx/core/provider/FontsContractCompat$f;->a:Landroid/graphics/Typeface;
    :try_end_0
    ...
    .line 11
    :cond_6
    new-instance p1, Landroidx/core/provider/FontsContractCompat$b;

    invoke-direct {p1, p2, p3}, Landroidx/core/provider/FontsContractCompat$b;-><init>(Landroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;)V
    ...
    new-instance p2, Landroidx/core/provider/FontsContractCompat$c;

    invoke-direct {p2, v0}, Landroidx/core/provider/FontsContractCompat$c;-><init>(Ljava/lang/String;)V
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    .line 7
    invoke-static {p1, p2}, Landroidx/core/provider/FontsContractCompat;->c(Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
...
.method public static requestFont(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/core/provider/FontsContractCompat;->f(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V
...
.method public static resetCache()V
    ...
    .line 1
    sget-object v0, Landroidx/core/provider/FontsContractCompat;->a:Landroidx/collection/LruCache;
