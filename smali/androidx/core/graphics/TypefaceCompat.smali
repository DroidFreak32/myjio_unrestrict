...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/graphics/TypefaceCompat;->a:Lj2;
...
.method public static b(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
    ...
    .line 1
    sget-object v0, Landroidx/core/graphics/TypefaceCompat;->a:Lj2;

    invoke-virtual {v0, p1}, Lj2;->d(Landroid/graphics/Typeface;)Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;
    ...
    .line 3
    invoke-virtual {v0, p0, p1, v1, p2}, Lj2;->createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
...
.method public static create(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
    ...
    .line 2
    invoke-static {p0, p1, p2}, Landroidx/core/graphics/TypefaceCompat;->b(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;
...
.method public static createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Lj2;->createFromFontInfo(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/FontsContractCompat$FontInfo;I)Landroid/graphics/Typeface;
...
.method public static createFromResourcesFamilyXml(Landroid/content/Context;Landroidx/core/content/res/FontResourcesParserCompat$FamilyResourceEntry;Landroid/content/res/Resources;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    .line 6
    :cond_3
    sget-object v1, Landroidx/core/graphics/TypefaceCompat;->a:Lj2;

    move-object v0, p1

    check-cast v0, Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;

    invoke-virtual {v1, p0, v0, p2, p4}, Lj2;->createFromFontFamilyFilesResourceEntry(Landroid/content/Context;Landroidx/core/content/res/FontResourcesParserCompat$FontFamilyFilesResourceEntry;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, p3, p4}, Landroidx/core/graphics/TypefaceCompat;->a(Landroid/content/res/Resources;II)Ljava/lang/String;
...
.method public static createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v5}, Lj2;->createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    .line 2
    invoke-static {p1, p2, p4}, Landroidx/core/graphics/TypefaceCompat;->a(Landroid/content/res/Resources;II)Ljava/lang/String;
...
.method public static findFromCache(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/graphics/TypefaceCompat;->a(Landroid/content/res/Resources;II)Ljava/lang/String;
