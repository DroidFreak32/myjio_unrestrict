...
.method public constructor <init>(Landroidx/recyclerview/widget/DiffUtil$Callback;Ljava/util/List;[I[IZ)V
    ...
    .line 11
    invoke-virtual {p0}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->a()V

    .line 12
    invoke-virtual {p0}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->f()V

    return-void
.end method

.method public static h(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$b;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v2, Landroidx/recyclerview/widget/DiffUtil$b;

    .line 3
    iget v3, v2, Landroidx/recyclerview/widget/DiffUtil$b;->a:I

    if-ne v3, p1, :cond_2

    iget-boolean v3, v2, Landroidx/recyclerview/widget/DiffUtil$b;->c:Z
    ...
    check-cast p1, Landroidx/recyclerview/widget/DiffUtil$b;

    iget v3, p1, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
    ...
    iput v3, p1, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
...
.method public final a()V
    ...
    .line 2
    iget v2, v0, Landroidx/recyclerview/widget/DiffUtil$d;->a:I
    ...
    .line 4
    iput v1, v0, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    .line 5
    iput v1, v0, Landroidx/recyclerview/widget/DiffUtil$d;->b:I

    .line 6
    iput-boolean v1, v0, Landroidx/recyclerview/widget/DiffUtil$d;->d:Z

    .line 7
    iput v1, v0, Landroidx/recyclerview/widget/DiffUtil$d;->c:I

    .line 8
    iput-boolean v1, v0, Landroidx/recyclerview/widget/DiffUtil$d;->e:Z
...
.method public final b(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, p3, v3}, Landroidx/recyclerview/widget/DiffUtil$b;-><init>(IIZ)V
    ...
    .line 8
    invoke-static {p1, v1, v0}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->h(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$b;

    move-result-object v5

    .line 9
    iget v5, v5, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
    ...
    .line 15
    iget v3, v2, Landroidx/recyclerview/widget/DiffUtil$b;->b:I

    add-int/2addr v3, v0

    iput v3, v2, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
...
.method public final c(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, v3, v0}, Landroidx/recyclerview/widget/DiffUtil$b;-><init>(IIZ)V
    ...
    .line 8
    invoke-static {p1, v1, v5}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->h(Ljava/util/List;IZ)Landroidx/recyclerview/widget/DiffUtil$b;
    ...
    .line 9
    iget v7, v5, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
    ...
    .line 10
    iget v3, v5, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
...
.method public convertNewPositionToOld(I)I
    ...
    iget p1, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->f:I
...
.method public convertOldPositionToNew(I)I
    ...
    iget p1, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->e:I
...
.method public final d(III)V
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->e(IIIZ)Z
...
.method public dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
    ...
    check-cast v10, Landroidx/recyclerview/widget/DiffUtil$d;

    .line 10
    iget v11, v10, Landroidx/recyclerview/widget/DiffUtil$d;->c:I

    .line 11
    iget v2, v10, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    add-int v12, v2, v11

    .line 12
    iget v2, v10, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
    ...
    .line 13
    invoke-virtual/range {v1 .. v6}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->c(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    .line 14
    invoke-virtual/range {v1 .. v6}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->b(Ljava/util/List;Landroidx/recyclerview/widget/ListUpdateCallback;III)V
    ...
    iget v4, v10, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
    ...
    .line 19
    :cond_4
    iget v1, v10, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    .line 20
    iget v8, v10, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
...
.method public final e(IIIZ)Z
    ...
    check-cast v2, Landroidx/recyclerview/widget/DiffUtil$d;

    .line 2
    iget v3, v2, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    iget v4, v2, Landroidx/recyclerview/widget/DiffUtil$d;->c:I

    add-int/2addr v3, v4

    .line 3
    iget v5, v2, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
    ...
    .line 12
    :cond_6
    iget v1, v2, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    .line 13
    iget p2, v2, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
...
.method public final f()V
    ...
    check-cast v4, Landroidx/recyclerview/widget/DiffUtil$d;

    .line 5
    iget v5, v4, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    iget v6, v4, Landroidx/recyclerview/widget/DiffUtil$d;->c:I

    add-int/2addr v5, v6

    .line 6
    iget v7, v4, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
    ...
    .line 8
    invoke-virtual {p0, v0, v1, v2}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->d(III)V
    ...
    .line 9
    invoke-virtual {p0, v0, v1, v2}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->g(III)V
    ...
    .line 10
    :goto_3
    iget v1, v4, Landroidx/recyclerview/widget/DiffUtil$d;->c:I

    if-ge v0, v1, :cond_3

    .line 11
    iget v1, v4, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    add-int/2addr v1, v0

    .line 12
    iget v5, v4, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
    ...
    .line 17
    :cond_3
    iget v0, v4, Landroidx/recyclerview/widget/DiffUtil$d;->a:I

    .line 18
    iget v1, v4, Landroidx/recyclerview/widget/DiffUtil$d;->b:I
