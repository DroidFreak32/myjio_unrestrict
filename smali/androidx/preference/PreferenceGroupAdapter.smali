...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/preference/PreferenceGroupAdapter$d;
    }
.end annotation
...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    .line 2
    new-instance v0, Landroidx/preference/PreferenceGroupAdapter$a;

    invoke-direct {v0, p0}, Landroidx/preference/PreferenceGroupAdapter$a;-><init>(Landroidx/preference/PreferenceGroupAdapter;)V

    iput-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;->y:Ljava/lang/Runnable;
    ...
    invoke-virtual {p1, p0}, Landroidx/preference/Preference;->j(Landroidx/preference/Preference$b;)V
    ...
    .line 12
    :goto_0
    invoke-virtual {p0}, Landroidx/preference/PreferenceGroupAdapter;->f()V
...
# virtual methods
.method public final a(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Ld4;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p2, v2, v3}, Ld4;-><init>(Landroid/content/Context;Ljava/util/List;J)V

    .line 4
    new-instance p2, Landroidx/preference/PreferenceGroupAdapter$c;

    invoke-direct {p2, p0, p1}, Landroidx/preference/PreferenceGroupAdapter$c;-><init>(Landroidx/preference/PreferenceGroupAdapter;Landroidx/preference/PreferenceGroup;)V
...
.method public final b(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    .line 6
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/preference/PreferenceGroupAdapter;->d(Landroidx/preference/PreferenceGroup;)Z
    ...
    invoke-virtual {p0, v5}, Landroidx/preference/PreferenceGroupAdapter;->d(Landroidx/preference/PreferenceGroup;)Z
    ...
    :cond_6
    :goto_3
    invoke-virtual {p0, v5}, Landroidx/preference/PreferenceGroupAdapter;->b(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    .line 23
    invoke-virtual {p0, p1, v1}, Landroidx/preference/PreferenceGroupAdapter;->a(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Ld4;
...
.method public final c(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    new-instance v3, Landroidx/preference/PreferenceGroupAdapter$d;

    invoke-direct {v3, v2}, Landroidx/preference/PreferenceGroupAdapter$d;-><init>(Landroidx/preference/Preference;)V
    ...
    .line 11
    invoke-virtual {p0, p1, v3}, Landroidx/preference/PreferenceGroupAdapter;->c(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    .line 12
    :cond_1
    invoke-virtual {v2, p0}, Landroidx/preference/Preference;->j(Landroidx/preference/Preference$b;)V
...
.method public final d(Landroidx/preference/PreferenceGroup;)Z
    .locals 1
...
.method public f()V
    ...
    .line 2
    invoke-virtual {v1, v2}, Landroidx/preference/Preference;->j(Landroidx/preference/Preference$b;)V
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/preference/PreferenceGroupAdapter;->c(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/preference/PreferenceGroupAdapter;->b(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    invoke-direct {v3, p0, v0, v1, v2}, Landroidx/preference/PreferenceGroupAdapter$b;-><init>(Landroidx/preference/PreferenceGroupAdapter;Ljava/util/List;Ljava/util/List;Landroidx/preference/PreferenceManager$PreferenceComparisonCallback;)V
...
.method public getItemViewType(I)I
    ...
    .line 2
    new-instance v0, Landroidx/preference/PreferenceGroupAdapter$d;

    invoke-direct {v0, p1}, Landroidx/preference/PreferenceGroupAdapter$d;-><init>(Landroidx/preference/Preference;)V
...
.method public getPreferenceAdapterPosition(Landroidx/preference/Preference;)I
    ...
    .line 5
    iget-object v2, p0, Landroidx/preference/PreferenceGroupAdapter;->c:Ljava/util/List;
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/preference/PreferenceViewHolder;
    ...
    check-cast p2, Landroidx/preference/PreferenceGroupAdapter$d;
    ...
    .line 9
    iget v1, p2, Landroidx/preference/PreferenceGroupAdapter$d;->a:I
    ...
    .line 13
    iget p2, p2, Landroidx/preference/PreferenceGroupAdapter$d;->b:I
...
.method public onPreferenceHierarchyChange(Landroidx/preference/Preference;)V
    ...
    iget-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;->y:Ljava/lang/Runnable;
