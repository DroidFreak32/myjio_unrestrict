...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->i0:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->t:Landroid/content/res/ColorStateList;

    .line 5
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->u:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 8
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->y:Landroid/content/res/ColorStateList;

    .line 9
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->z:Landroid/graphics/PorterDuff$Mode;

    .line 10
    iput-boolean v1, p0, Landroidx/appcompat/widget/SwitchCompat;->A:Z

    .line 11
    iput-boolean v1, p0, Landroidx/appcompat/widget/SwitchCompat;->B:Z
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/view/VelocityTracker;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->h0:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/text/TextPaint;
    ...
    .line 17
    sget-object v2, Lb0;->SwitchCompat:[I

    invoke-static {p1, p2, v2, p3, v1}, Lf3;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lf3;

    move-result-object v2

    .line 18
    sget v4, Lb0;->SwitchCompat_android_thumb:I

    invoke-virtual {v2, v4}, Lf3;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 21
    :cond_0
    sget v4, Lb0;->SwitchCompat_track:I

    invoke-virtual {v2, v4}, Lf3;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->x:Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    :cond_1
    sget v4, Lb0;->SwitchCompat_android_textOn:I

    invoke-virtual {v2, v4}, Lf3;->e(I)Ljava/lang/CharSequence;

    move-result-object v4

    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->G:Ljava/lang/CharSequence;

    .line 25
    sget v4, Lb0;->SwitchCompat_android_textOff:I

    invoke-virtual {v2, v4}, Lf3;->e(I)Ljava/lang/CharSequence;

    move-result-object v4

    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->H:Ljava/lang/CharSequence;

    .line 26
    sget v4, Lb0;->SwitchCompat_showText:I

    invoke-virtual {v2, v4, v3}, Lf3;->a(IZ)Z
    ...
    .line 27
    sget v4, Lb0;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v2, v4, v1}, Lf3;->c(II)I
    ...
    .line 28
    sget v4, Lb0;->SwitchCompat_switchMinWidth:I

    invoke-virtual {v2, v4, v1}, Lf3;->c(II)I

    move-result v4

    iput v4, p0, Landroidx/appcompat/widget/SwitchCompat;->D:I

    .line 29
    sget v4, Lb0;->SwitchCompat_switchPadding:I
    ...
    .line 30
    sget v4, Lb0;->SwitchCompat_splitTrack:I

    invoke-virtual {v2, v4, v1}, Lf3;->a(IZ)Z
    ...
    .line 31
    sget v4, Lb0;->SwitchCompat_thumbTint:I

    invoke-virtual {v2, v4}, Lf3;->a(I)Landroid/content/res/ColorStateList;
    ...
    .line 33
    iput-boolean v3, p0, Landroidx/appcompat/widget/SwitchCompat;->v:Z

    .line 34
    :cond_2
    sget v4, Lb0;->SwitchCompat_thumbTintMode:I

    const/4 v5, -0x1

    .line 35
    invoke-virtual {v2, v4, v5}, Lf3;->d(II)I

    move-result v4

    .line 36
    invoke-static {v4, v0}, Lq2;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    .line 37
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->u:Landroid/graphics/PorterDuff$Mode;

    if-eq v6, v4, :cond_3

    .line 38
    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->u:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 42
    :cond_5
    sget v4, Lb0;->SwitchCompat_trackTint:I
    ...
    .line 43
    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->y:Landroid/content/res/ColorStateList;
    ...
    .line 45
    :cond_6
    sget v4, Lb0;->SwitchCompat_trackTintMode:I
    ...
    .line 50
    iput-boolean v3, p0, Landroidx/appcompat/widget/SwitchCompat;->B:Z
    ...
    .line 53
    :cond_9
    sget v0, Lb0;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v2, v0, v1}, Lf3;->g(II)I
    ...
    invoke-direct {v0, p0}, Lm2;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->g0:Lm2;

    .line 56
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->g0:Lm2;

    invoke-virtual {v0, p2, p3}, Lm2;->a(Landroid/util/AttributeSet;I)V

    .line 57
    invoke-virtual {v2}, Lf3;->a()V
...
.method private getTargetCheckedState()Z
    ...
    .line 1
    iget v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P:F
...
.method private getThumbOffset()I
    ...
    .line 1
    invoke-static {p0}, Ll3;->a(Landroid/view/View;)Z
    ...
    .line 2
    iget v1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:F
...
.method private getThumbScrollRange()I
    ...
    .line 5
    invoke-static {v0}, Lq2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 6
    :cond_0
    sget-object v0, Lq2;->c:Landroid/graphics/Rect;
...
.method public final a(Ljava/lang/CharSequence;)Landroid/text/Layout;
    ...
    .line 13
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/text/method/TransformationMethod;
...
.method public final a()V
    ...
    invoke-static {v0, v1}, Lp7;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v0, v1}, Lp7;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public final a(Z)V
    ...
    .line 28
    :goto_0
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->i0:Landroid/util/Property;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/animation/ObjectAnimator;
...
.method public final a(FF)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->h0:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->h0:Landroid/graphics/Rect;
...
.method public final b(Landroid/view/MotionEvent;)V
    ...
    .line 12
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/view/VelocityTracker;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->h0:Landroid/graphics/Rect;
    ...
    .line 7
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->s:Landroid/graphics/drawable/Drawable;

    if-eqz v6, :cond_0

    .line 8
    invoke-static {v6}, Lq2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 9
    :cond_0
    sget-object v6, Lq2;->c:Landroid/graphics/Rect;

    .line 10
    :goto_0
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->x:Landroid/graphics/drawable/Drawable;
    ...
    .line 24
    invoke-static {v0, v1, v2, v5, v4}, Lp7;->a(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public onCreateDrawableState(I)[I
    ...
    .line 3
    sget-object v0, Landroidx/appcompat/widget/SwitchCompat;->j0:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 12
    invoke-static {v4}, Lq2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 25
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/content/res/ColorStateList;

    if-eqz v6, :cond_5

    .line 26
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/text/TextPaint;
...
.method public onLayout(ZIIII)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->h0:Landroid/graphics/Rect;

    .line 4
    iget-object p3, p0, Landroidx/appcompat/widget/SwitchCompat;->x:Landroid/graphics/drawable/Drawable;
    ...
    .line 7
    :goto_0
    iget-object p3, p0, Landroidx/appcompat/widget/SwitchCompat;->s:Landroid/graphics/drawable/Drawable;

    invoke-static {p3}, Lq2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 12
    iget p3, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:I
    ...
    .line 14
    iget p1, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:I
    ...
    .line 17
    iget p4, p0, Landroidx/appcompat/widget/SwitchCompat;->R:I
    ...
    .line 19
    iget p2, p0, Landroidx/appcompat/widget/SwitchCompat;->R:I
    ...
    .line 23
    iput p4, p0, Landroidx/appcompat/widget/SwitchCompat;->W:I

    .line 24
    iput p3, p0, Landroidx/appcompat/widget/SwitchCompat;->V:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/view/VelocityTracker;
    ...
    .line 9
    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->P:F
    ...
    iget v4, p0, Landroidx/appcompat/widget/SwitchCompat;->M:F
    ...
    .line 18
    iput v0, p0, Landroidx/appcompat/widget/SwitchCompat;->L:F

    .line 19
    iput v3, p0, Landroidx/appcompat/widget/SwitchCompat;->M:F
    ...
    .line 30
    iput v2, p0, Landroidx/appcompat/widget/SwitchCompat;->M:F
...
.method public setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    .line 2
    sget p2, Lb0;->TextAppearance_android_textColor:I

    invoke-virtual {p1, p2}, Lf3;->a(I)Landroid/content/res/ColorStateList;
    ...
    .line 5
    :goto_0
    sget p2, Lb0;->TextAppearance_android_textSize:I

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0}, Lf3;->c(II)I
    ...
    .line 9
    :cond_1
    sget p2, Lb0;->TextAppearance_android_typeface:I

    const/4 v1, -0x1

    invoke-virtual {p1, p2, v1}, Lf3;->d(II)I

    move-result p2

    .line 10
    sget v2, Lb0;->TextAppearance_android_textStyle:I

    invoke-virtual {p1, v2, v1}, Lf3;->d(II)I
    ...
    .line 12
    sget p2, Lb0;->TextAppearance_textAllCaps:I

    invoke-virtual {p1, p2, v0}, Lf3;->a(IZ)Z
    ...
    invoke-direct {p2, v0}, Lx0;-><init>(Landroid/content/Context;)V
...
.method public setThumbPosition(F)V
    ...
    .line 1
    iput p1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:F
