...
.field public final w:Ljava/nio/channels/FileChannel;
...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 3
    iput-object p1, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/File;

    .line 4
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/io/File;
    ...
    iput-wide v0, p0, Landroidx/multidex/MultiDexExtractor;->t:J
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->v:Ljava/io/RandomAccessFile;

    .line 8
    :try_start_0
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->v:Ljava/io/RandomAccessFile;

    invoke-virtual {p2}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p2

    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->w:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    .line 10
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->w:Ljava/nio/channels/FileChannel;

    invoke-virtual {p2}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object p2

    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->x:Ljava/nio/channels/FileLock;
    :try_end_1
...
.method public static b(Ljava/io/File;)J
    ...
    .line 1
    invoke-static {p0}, Llf;->a(Ljava/io/File;)J
...
.method public final a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/File;
    ...
    iget-object v9, v0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/io/File;
...
.method public a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v3, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/File;
    ...
    .line 2
    iget-object v2, p0, Landroidx/multidex/MultiDexExtractor;->x:Ljava/nio/channels/FileLock;
    ...
    .line 3
    iget-object v2, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/File;

    iget-wide v3, p0, Landroidx/multidex/MultiDexExtractor;->t:J

    invoke-static {p1, v2, v3, v4, p2}, Landroidx/multidex/MultiDexExtractor;->a(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    .line 4
    :try_start_0
    invoke-virtual {p0, p1, p2}, Landroidx/multidex/MultiDexExtractor;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 5
    :catch_0
    invoke-virtual {p0}, Landroidx/multidex/MultiDexExtractor;->b()Ljava/util/List;

    move-result-object v7

    .line 6
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/File;

    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->a(Ljava/io/File;)J

    move-result-wide v2

    iget-wide v8, p0, Landroidx/multidex/MultiDexExtractor;->t:J
    ...
    invoke-static/range {v0 .. v6}, Landroidx/multidex/MultiDexExtractor;->a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public final a()V
    ...
    .line 41
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/io/File;
    ...
    iget-object v1, p0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/io/File;
...
.method public final b()Ljava/util/List;
    ...
    .line 3
    invoke-virtual {p0}, Landroidx/multidex/MultiDexExtractor;->a()V
    ...
    iget-object v5, p0, Landroidx/multidex/MultiDexExtractor;->s:Ljava/io/File;
    ...
    iget-object v9, p0, Landroidx/multidex/MultiDexExtractor;->u:Ljava/io/File;
    ...
    .line 11
    invoke-static {v4, v6, v8, v2}, Landroidx/multidex/MultiDexExtractor;->a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->x:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    .line 2
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->w:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 3
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->v:Ljava/io/RandomAccessFile;
