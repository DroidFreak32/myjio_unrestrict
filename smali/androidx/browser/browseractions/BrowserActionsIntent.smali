...
.field public static b:Landroidx/browser/browseractions/BrowserActionsIntent$a;
...
.method public static b(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    .locals 4
    ...
    :cond_4
    :goto_2
    invoke-static {p0, p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->c(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public static c(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 5
    :goto_0
    invoke-static {p0, v0, v1, p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->d(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V

    return-void
.end method

.method public static d(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p2, p0, p1, p3}, Lo1;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V

    .line 2
    invoke-virtual {p2}, Lo1;->a()V

    .line 3
    sget-object p0, Landroidx/browser/browseractions/BrowserActionsIntent;->b:Landroidx/browser/browseractions/BrowserActionsIntent$a;
...
.method public static launchIntent(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 2
    invoke-static {p0, p1, v0}, Landroidx/browser/browseractions/BrowserActionsIntent;->b(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
