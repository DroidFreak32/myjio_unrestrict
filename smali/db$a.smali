...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    .line 2
    iput-object p1, p0, Ldb$a;->a:Landroid/view/ActionMode$Callback;

    .line 3
    iput-object p2, p0, Ldb$a;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    .line 4
    iput-boolean p1, p0, Ldb$a;->f:Z
...
.method public final a(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    .line 38
    invoke-virtual {p0}, Ldb$a;->a()Landroid/content/Intent;

    move-result-object v0

    .line 39
    invoke-virtual {p0, p2}, Ldb$a;->a(Landroid/widget/TextView;)Z
...
.method public final a(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 32
    invoke-virtual {p0, v1, p1}, Ldb$a;->a(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method public final a(Landroid/view/Menu;)V
    ...
    .line 1
    iget-object v0, p0, Ldb$a;->b:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Ldb$a;->c:Ljava/lang/Class;

    .line 6
    iget-object v2, p0, Ldb$a;->c:Ljava/lang/Class;
    ...
    iput-object v2, p0, Ldb$a;->d:Ljava/lang/reflect/Method;

    .line 8
    iput-boolean v5, p0, Ldb$a;->e:Z
    :try_end_0
    ...
    .line 11
    iput-boolean v4, p0, Ldb$a;->e:Z

    .line 12
    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v2, p0, Ldb$a;->e:Z
    ...
    iget-object v2, p0, Ldb$a;->d:Ljava/lang/reflect/Method;
    ...
    .line 21
    :cond_3
    invoke-virtual {p0, v0, v1}, Ldb$a;->a(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v7, p0, Ldb$a;->b:Landroid/widget/TextView;

    .line 26
    invoke-virtual {p0, v3, v7}, Ldb$a;->a(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    .line 1
    iget-object v0, p0, Ldb$a;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    .line 1
    invoke-virtual {p0, p2}, Ldb$a;->a(Landroid/view/Menu;)V
