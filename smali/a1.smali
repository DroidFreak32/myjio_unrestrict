...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, La1;->a:Landroid/widget/ProgressBar;
...
.method public b()Landroid/graphics/Bitmap;
    ...
    .line 1
    iget-object v0, p0, La1;->b:Landroid/graphics/Bitmap;
...
.method public c(Landroid/util/AttributeSet;I)V
    ...
    .line 1
    iget-object v0, p0, La1;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, La1;->c:[I
    ...
    invoke-virtual {p0, p2}, La1;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, La1;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p0, v1, p2}, La1;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, La1;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 16
    iget-object v2, p0, La1;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    .line 17
    iput-object v0, p0, La1;->b:Landroid/graphics/Bitmap;

    .line 18
    :cond_6
    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {p0}, La1;->a()Landroid/graphics/drawable/shapes/Shape;
...
.method public final e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v4, v5}, La1;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
