...
.method public constructor <init>(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;IZ)V
    ...
    .line 4
    iput-object p1, p0, Lf5;->a:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    .line 5
    iput p2, p0, Lf5;->l:I

    .line 6
    iput-boolean p3, p0, Lf5;->m:Z
...
.method public final b()V
    ...
    .line 2
    iget-object v2, p0, Lf5;->a:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 4
    iget-object v7, v4, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->i0:[Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 5
    iget-object v7, v4, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->h0:[Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 7
    iget-object v7, p0, Lf5;->b:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    if-nez v7, :cond_0

    .line 8
    iput-object v4, p0, Lf5;->b:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    .line 9
    :cond_0
    iput-object v4, p0, Lf5;->d:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 12
    iget-object v7, v4, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->g0:[F
    ...
    invoke-static {v4, v7}, Lf5;->a(Landroidx/constraintlayout/solver/widgets/ConstraintWidget;I)Z
    ...
    .line 15
    iput-boolean v6, p0, Lf5;->n:Z

    goto :goto_1

    .line 16
    :cond_3
    iput-boolean v6, p0, Lf5;->o:Z

    .line 17
    :goto_1
    iget-object v7, p0, Lf5;->h:Ljava/util/ArrayList;
    ...
    iput-object v7, p0, Lf5;->h:Ljava/util/ArrayList;
    ...
    .line 20
    :cond_5
    iget-object v7, p0, Lf5;->f:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    if-nez v7, :cond_6

    .line 21
    iput-object v4, p0, Lf5;->f:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    .line 22
    :cond_6
    iget-object v7, p0, Lf5;->g:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 24
    :cond_7
    iput-object v4, p0, Lf5;->g:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    :cond_8
    if-eq v5, v4, :cond_9

    .line 25
    iget-object v5, v5, Landroidx/constraintlayout/solver/widgets/ConstraintWidget;->i0:[Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 29
    :cond_d
    iput-object v4, p0, Lf5;->c:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;
    ...
    .line 31
    iget-object v0, p0, Lf5;->c:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    iput-object v0, p0, Lf5;->e:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    goto :goto_4

    .line 32
    :cond_e
    iget-object v0, p0, Lf5;->a:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    iput-object v0, p0, Lf5;->e:Landroidx/constraintlayout/solver/widgets/ConstraintWidget;

    .line 33
    :goto_4
    iget-boolean v0, p0, Lf5;->o:Z

    if-eqz v0, :cond_f

    iget-boolean v0, p0, Lf5;->n:Z
