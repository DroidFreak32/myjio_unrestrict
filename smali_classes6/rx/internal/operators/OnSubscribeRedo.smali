...
# static fields
.field public static final y:Lrx/functions/Func1;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lrx/functions/Func1<",
            "Lrx/Observable<",
...
.method public static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lrx/internal/operators/OnSubscribeRedo$a;

    invoke-direct {v0}, Lrx/internal/operators/OnSubscribeRedo$a;-><init>()V

    sput-object v0, Lrx/internal/operators/OnSubscribeRedo;->y:Lrx/functions/Func1;

    return-void
.end method

.method public constructor <init>(Lrx/Observable;Lrx/functions/Func1;ZZLrx/Scheduler;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lrx/internal/operators/OnSubscribeRedo;->a:Lrx/Observable;

    .line 3
    iput-object p2, p0, Lrx/internal/operators/OnSubscribeRedo;->b:Lrx/functions/Func1;

    .line 4
    iput-boolean p3, p0, Lrx/internal/operators/OnSubscribeRedo;->c:Z

    .line 5
    iput-boolean p4, p0, Lrx/internal/operators/OnSubscribeRedo;->d:Z

    .line 6
    iput-object p5, p0, Lrx/internal/operators/OnSubscribeRedo;->e:Lrx/Scheduler;
...
.method public static repeat(Lrx/Observable;Lrx/Scheduler;)Lrx/Observable;
    ...
    .line 2
    sget-object v0, Lrx/internal/operators/OnSubscribeRedo;->y:Lrx/functions/Func1;
...
.method public call(Lrx/Subscriber;)V
    ...
    .line 4
    iget-object v0, p0, Lrx/internal/operators/OnSubscribeRedo;->e:Lrx/Scheduler;
    ...
    .line 12
    new-instance v12, Lrx/internal/operators/OnSubscribeRedo$b;
    ...
    invoke-direct/range {v1 .. v7}, Lrx/internal/operators/OnSubscribeRedo$b;-><init>(Lrx/internal/operators/OnSubscribeRedo;Lrx/Subscriber;Lrx/subjects/Subject;Lrx/internal/producers/ProducerArbiter;Ljava/util/concurrent/atomic/AtomicLong;Lrx/subscriptions/SerialSubscription;)V

    .line 13
    iget-object v1, p0, Lrx/internal/operators/OnSubscribeRedo;->b:Lrx/functions/Func1;

    new-instance v2, Lrx/internal/operators/OnSubscribeRedo$c;

    invoke-direct {v2, p0}, Lrx/internal/operators/OnSubscribeRedo$c;-><init>(Lrx/internal/operators/OnSubscribeRedo;)V
    ...
    .line 14
    new-instance v13, Lrx/internal/operators/OnSubscribeRedo$d;
    ...
    invoke-direct/range {v0 .. v7}, Lrx/internal/operators/OnSubscribeRedo$d;-><init>(Lrx/internal/operators/OnSubscribeRedo;Lrx/Observable;Lrx/Subscriber;Ljava/util/concurrent/atomic/AtomicLong;Lrx/Scheduler$Worker;Lrx/functions/Action0;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-virtual {v10, v13}, Lrx/Scheduler$Worker;->schedule(Lrx/functions/Action0;)Lrx/Subscription;

    .line 15
    new-instance v7, Lrx/internal/operators/OnSubscribeRedo$e;
    ...
    invoke-direct/range {v0 .. v6}, Lrx/internal/operators/OnSubscribeRedo$e;-><init>(Lrx/internal/operators/OnSubscribeRedo;Ljava/util/concurrent/atomic/AtomicLong;Lrx/internal/producers/ProducerArbiter;Ljava/util/concurrent/atomic/AtomicBoolean;Lrx/Scheduler$Worker;Lrx/functions/Action0;)V
