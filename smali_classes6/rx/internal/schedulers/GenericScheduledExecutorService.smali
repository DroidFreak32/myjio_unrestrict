...
.method public static constructor <clinit>()V
    ...
    .line 1
    sput-object v1, Lrx/internal/schedulers/GenericScheduledExecutorService;->b:[Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->c:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lrx/internal/schedulers/GenericScheduledExecutorService;->b:[Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static getInstance()Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object v0, v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 3
    sget-object v0, Lrx/internal/schedulers/GenericScheduledExecutorService;->c:Ljava/util/concurrent/ScheduledExecutorService;

    return-object v0

    .line 4
    :cond_0
    sget v1, Lrx/internal/schedulers/GenericScheduledExecutorService;->d:I
    ...
    .line 6
    :cond_1
    sput v1, Lrx/internal/schedulers/GenericScheduledExecutorService;->d:I
...
.method public shutdown()V
    ...
    .line 1
    :cond_0
    iget-object v0, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 3
    :cond_1
    iget-object v2, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public start()V
    ...
    .line 5
    :cond_2
    iget-object v3, p0, Lrx/internal/schedulers/GenericScheduledExecutorService;->a:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v4, Lrx/internal/schedulers/GenericScheduledExecutorService;->b:[Ljava/util/concurrent/ScheduledExecutorService;
