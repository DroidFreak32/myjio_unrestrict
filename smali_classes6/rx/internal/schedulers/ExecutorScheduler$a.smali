.class public final Lrx/internal/schedulers/ExecutorScheduler$a;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->b:Lrx/subscriptions/CompositeSubscription;
    ...
    iput-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->e:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public schedule(Lrx/functions/Action0;)Lrx/Subscription;
    ...
    .line 5
    iget-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->b:Lrx/subscriptions/CompositeSubscription;

    invoke-virtual {p1, v0}, Lrx/subscriptions/CompositeSubscription;->add(Lrx/Subscription;)V

    .line 6
    iget-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->c:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {p1, v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;->offer(Ljava/lang/Object;)Z

    .line 7
    iget-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 8
    :try_start_0
    iget-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->a:Ljava/util/concurrent/Executor;
...
.method public schedule(Lrx/functions/Action0;JLjava/util/concurrent/TimeUnit;)Lrx/Subscription;
    ...
    .line 21
    new-instance v2, Lrx/internal/schedulers/ExecutorScheduler$a$a;

    invoke-direct {v2, p0, v1}, Lrx/internal/schedulers/ExecutorScheduler$a$a;-><init>(Lrx/internal/schedulers/ExecutorScheduler$a;Lrx/subscriptions/MultipleAssignmentSubscription;)V
    ...
    new-instance v4, Lrx/internal/schedulers/ExecutorScheduler$a$b;

    invoke-direct {v4, p0, v1, p1, v2}, Lrx/internal/schedulers/ExecutorScheduler$a$b;-><init>(Lrx/internal/schedulers/ExecutorScheduler$a;Lrx/subscriptions/MultipleAssignmentSubscription;Lrx/functions/Action0;Lrx/Subscription;)V
    ...
    .line 24
    :try_start_0
    iget-object p1, p0, Lrx/internal/schedulers/ExecutorScheduler$a;->e:Ljava/util/concurrent/ScheduledExecutorService;
