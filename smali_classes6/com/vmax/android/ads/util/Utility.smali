...
# static fields
.field private static ALL_CHARS:[C = null
...
.field private static DCR_CHARS:[C = null
...
.field private static final IS_4G_CONNECTED:Ljava/lang/String; = "5"

.field private static final IS_CARRIER_CONNECTED:Ljava/lang/String; = "2"

.field private static final IS_LAN_CONNECTED:Ljava/lang/String; = "6"

.field private static final IS_WIFI_CONNECTED:Ljava/lang/String; = "1"

.field private static final SERVICE_ACTION:Ljava/lang/String; = "android.support.customtabs.action.CustomTabsService"

.field private static final TWO_MINUTES:I = 0x1d4c0

.field private static decrypt_seed:I

.field private static mAnimationProgress:Z
...
.method public static checkMOATCompatibility()Z
    ...
    :try_start_0
    const-string v1, "com.moat.analytics.mobile.rel.MoatAnalytics"
    ...
    const-string v1, "com.vmax.android.ads.mediation.partners.VmaxMOAT"
...
.method public static checkOMCompatibility()Z
    ...
    :try_start_0
    const-string v1, "com.iab.omid.library.vmax.adsession.AdSession"
    ...
    const-string v1, "com.vmax.android.ads.mediation.partners.VmaxOM"
...
.method public static handleChromeandExternalClick(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :try_start_0
    const-string v1, "androidx.browser.customtabs.CustomTabsIntent"
...
.method private static isChromeCustomTabsSupported(Landroid/content/Context;)Z
    .locals 2
...
.method private static isMemoryAvailable(I)Z
    .locals 8
...
.method public static replaceMacros(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;)Ljava/lang/String;
    ...
    const-string v3, "%5Bst%5D"

    const-string v4, "%7Bco%7D"

    const-string v5, "%7Bci%7D"

    const-string v6, "dvm"

    const-string v7, "%5Bco%5D"

    const-string v8, "%5Bci%5D"

    const-string v9, "vr"

    const-string v10, "%7Buid%7D"

    const-string v11, "%5Buid%5D"

    const-string v12, "st"

    const-string v13, "%7Bua%7D"

    const-string v14, "%5Bua%5D"

    const-string v15, "ci"

    move-object/from16 v16, v2

    const-string v2, "%7Badvid%7D"

    move-object/from16 v17, v6

    const-string v6, "%7Bccb%7D"

    move-object/from16 v18, v9

    const-string v9, "%5Badvid%5D"

    move-object/from16 v19, v3

    const-string v3, "%5Bccb%5D"
    ...
    invoke-virtual {v0, v13, v2}, Ljava/lang/String;->replaceAll(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v11, v2}, Ljava/lang/String;->replaceAll(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private static shuffle(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 7
