...
.method private insertACS()V
    ...
    invoke-virtual {v0, v2, v1}, Lin/juspay/android_lib/core/JsInterface;->setSessionAttribute(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lin/juspay/godel/ui/JuspayWebViewClient;->browserFragment:Lin/juspay/godel/ui/PaymentFragment;

    invoke-virtual {v2}, Lin/juspay/godel/ui/PaymentFragment;->getWebView()Lin/juspay/godel/ui/JuspayWebView;

    move-result-object v2

    const-string v3, "__juspay.trackWebLabRules();"

    invoke-virtual {v2, v3}, Lin/juspay/godel/ui/JuspayWebView;->addJsToWebView(Ljava/lang/String;)V
...
.method private trackSslError(Landroid/webkit/WebView;Landroid/webkit/SslErrorHandler;Landroid/net/http/SslError;)V
    ...
    invoke-virtual {p2, p3, v0, v1, p1}, Lin/juspay/android_lib/core/SdkTracker;->trackEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public onReceivedSslError(Landroid/webkit/WebView;Landroid/webkit/SslErrorHandler;Landroid/net/http/SslError;)V
    ...
    const-string v2, "Current URL is %s"
    ...
    invoke-virtual {v5, v1, v6}, Lin/juspay/android_lib/core/SdkTracker;->trackEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v6}, Lin/juspay/android_lib/core/SdkTracker;->trackEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "Certificate details: "
    ...
    invoke-static {v5, v2}, Lin/juspay/android_lib/core/JuspayLogger;->sdkDebug(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Certificate issued by: "
    ...
    const-string v3, "Certificate issued to: "
    ...
    :try_start_4
    iget-object v2, p0, Lin/juspay/godel/ui/JuspayWebViewClient;->juspayTrustManager:Lin/juspay/godel/core/h;

    invoke-virtual {p3}, Landroid/net/http/SslError;->getUrl()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, p1, v0, v3}, Lin/juspay/godel/core/h;->a(Landroid/webkit/WebView;Landroid/net/http/SslCertificate;Ljava/lang/String;)Z
    ...
    invoke-static {v2, v3, v0}, Lin/juspay/android_lib/core/JuspayLogger;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1, p3, v0}, Lin/juspay/android_lib/core/SdkTracker;->trackEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "Current URL from SSL Error is %s"
    ...
    const-string v2, "Letting %s go as it is whitelisted explicitly"
    ...
    invoke-static {v5, p1}, Lin/juspay/android_lib/core/JuspayLogger;->trackAndLogInfo(Ljava/lang/String;Ljava/lang/String;)V
