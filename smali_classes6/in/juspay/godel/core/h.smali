...
.method private a(Landroid/webkit/WebView;)[Ljava/security/cert/X509Certificate;
    ...
    :try_start_8
    invoke-virtual {v5, v2, v6}, Landroid/content/Context;->getDir(Ljava/lang/String;I)Ljava/io/File;
    ...
    :goto_7
    const-string v2, "caught while trying to open internal storage for trustmanager"

    invoke-static {v3, v2, v0}, Lin/juspay/android_lib/core/JuspayLogger;->trackAndLogException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v9, "certificates_v1/"
    ...
    invoke-static {v6, v5}, Lin/juspay/android_lib/data/FileProvider;->readFromFile(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v10, v0, v6}, Ljava/util/ArrayList;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v6, "caught while initing keystore from internal storage"
