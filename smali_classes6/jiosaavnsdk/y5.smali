...
.method public constructor <init>(Ljava/net/HttpCookie;)V
    ...
    iput-object v0, p0, Ljiosaavnsdk/y5;->a:Ljava/lang/String;

    invoke-virtual {p1}, Ljava/net/HttpCookie;->getVersion()I

    move-result v0

    iput v0, p0, Ljiosaavnsdk/y5;->b:I

    invoke-virtual {p1}, Ljava/net/HttpCookie;->getValue()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ljiosaavnsdk/y5;->c:Ljava/lang/String;

    invoke-virtual {p1}, Ljava/net/HttpCookie;->getDomain()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Ljiosaavnsdk/y5;->d:Ljava/lang/String;
    ...
    iput-object v0, p0, Ljiosaavnsdk/y5;->e:Ljava/lang/Long;

    invoke-virtual {p1}, Ljava/net/HttpCookie;->getPath()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Ljiosaavnsdk/y5;->f:Ljava/lang/String;
...
.method public a()Ljava/net/HttpCookie;
    ...
    iget-object v1, p0, Ljiosaavnsdk/y5;->a:Ljava/lang/String;

    iget-object v2, p0, Ljiosaavnsdk/y5;->c:Ljava/lang/String;

    invoke-direct {v0, v1, v2}, Ljava/net/HttpCookie;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget v1, p0, Ljiosaavnsdk/y5;->b:I

    invoke-virtual {v0, v1}, Ljava/net/HttpCookie;->setVersion(I)V

    iget-object v1, p0, Ljiosaavnsdk/y5;->d:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ljava/net/HttpCookie;->setDomain(Ljava/lang/String;)V

    iget-object v1, p0, Ljiosaavnsdk/y5;->e:Ljava/lang/Long;
    ...
    iget-object v1, p0, Ljiosaavnsdk/y5;->f:Ljava/lang/String;
