...
.method public static checkTerminated(ZZLcr4;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    .locals 2
    ...
    .line 4
    invoke-interface {p2, p0}, Lcr4;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 5
    :cond_1
    invoke-interface {p2}, Lcr4;->onComplete()V
...
.method public static drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lcr4;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 3
    invoke-static/range {v2 .. v7}, Lio/reactivex/internal/util/QueueDrainHelper;->checkTerminated(ZZLcr4;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    ...
    .line 7
    invoke-interface {p4, p1, v8}, Lio/reactivex/internal/util/QueueDrain;->accept(Lcr4;Ljava/lang/Object;)Z
    ...
    invoke-interface {p1, p0}, Lcr4;->onError(Ljava/lang/Throwable;)V
...
.method public static postComplete(Lcr4;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 2
    invoke-interface {p0}, Lcr4;->onComplete()V
    ...
    invoke-static/range {v1 .. v6}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLcr4;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    ...
    .line 6
    invoke-static/range {v9 .. v14}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLcr4;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z

    :cond_3
    return-void
.end method

.method public static postCompleteDrain(JLcr4;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 4
    :cond_2
    invoke-interface {p2, v5}, Lcr4;->onNext(Ljava/lang/Object;)V
...
.method public static postCompleteRequest(JLcr4;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 4
    invoke-static/range {v8 .. v13}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLcr4;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
...
.method public static request(Ldr4;I)V
    .locals 2
    ...
    .line 1
    :goto_0
    invoke-interface {p0, v0, v1}, Ldr4;->request(J)V
