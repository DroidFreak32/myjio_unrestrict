...
# direct methods
.method public constructor <init>(Lcr4;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lcr4;
...
.method public onSubscribe(Ldr4;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Ldr4;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Ldr4;
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lcr4;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lcr4;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Ldr4;

    invoke-interface {v3, v1, v2}, Ldr4;->request(J)V
...
.method public runAsync()V
    ...
    .line 7
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLcr4;)Z
    ...
    .line 8
    :cond_4
    invoke-interface {v0, v10}, Lcr4;->onNext(Ljava/lang/Object;)V
    ...
    .line 11
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Ldr4;

    invoke-interface {v8, v2, v3}, Ldr4;->request(J)V
    ...
    .line 16
    invoke-interface {v0, v2}, Lcr4;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLcr4;)Z
...
.method public runBackfused()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lcr4;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lcr4;->onNext(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lcr4;
...
.method public runSync()V
    ...
    .line 10
    :cond_2
    invoke-interface {v0, v8}, Lcr4;->onNext(Ljava/lang/Object;)V
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Ldr4;

    invoke-interface {v2}, Ldr4;->cancel()V

    .line 14
    invoke-interface {v0, v1}, Lcr4;->onError(Ljava/lang/Throwable;)V
