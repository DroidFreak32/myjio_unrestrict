...
# instance fields
.field public final boundary:Lbr4;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lbr4<",
            "TB;>;"
...
# direct methods
.method public constructor <init>(Lcr4;Ljava/util/concurrent/Callable;Lbr4;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Lcr4;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
    ...
    .line 3
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->boundary:Lbr4;
...
# virtual methods
.method public bridge synthetic accept(Lcr4;Ljava/lang/Object;)Z
    .locals 0

    .line 1
    check-cast p2, Ljava/util/Collection;

    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->accept(Lcr4;Ljava/util/Collection;)Z
...
.method public accept(Lcr4;Ljava/util/Collection;)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lcr4;

    invoke-interface {p1, p2}, Lcr4;->onNext(Ljava/lang/Object;)V
...
.method public cancel()V
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->upstream:Ldr4;
...
.method public next()V
    ...
    .line 11
    iget-object v1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lcr4;
...
.method public onComplete()V
    ...
    invoke-static {v0, v1, v2, p0, p0}, Lio/reactivex/internal/util/QueueDrainHelper;->drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Lcr4;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Lcr4;
...
.method public onSubscribe(Ldr4;)V
    ...
    .line 2
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->upstream:Ldr4;
    ...
    invoke-interface {v1, p0}, Lcr4;->onSubscribe(Ldr4;)V
    ...
    .line 9
    invoke-interface {p1, v1, v2}, Ldr4;->request(J)V

    .line 10
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferExactBoundary$BufferExactBoundarySubscriber;->boundary:Lbr4;
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lcr4;)V
