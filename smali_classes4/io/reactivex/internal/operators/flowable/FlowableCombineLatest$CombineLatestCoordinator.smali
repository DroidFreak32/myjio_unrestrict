...
# direct methods
.method public constructor <init>(Lcr4;Lio/reactivex/functions/Function;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lcr4;
...
.method public drainAsync()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lcr4;
    ...
    .line 6
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLcr4;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLcr4;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
...
.method public drainOutput()V
    ...
    .line 7
    invoke-interface {v0, v3}, Lcr4;->onError(Ljava/lang/Throwable;)V
    ...
    .line 10
    invoke-interface {v0, v5}, Lcr4;->onNext(Ljava/lang/Object;)V
...
.method public subscribe([Lbr4;I)V
    ...
    invoke-interface {v2, v3}, Lbr4;->subscribe(Lcr4;)V
