...
.method public drainNormal()V
    ...
    .line 7
    :goto_2
    invoke-virtual {p0, v12, v14, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLcr4;Z)Z
    ...
    .line 8
    :cond_3
    invoke-interface {v2, v13}, Lcr4;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v11, v12, v2, v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$State;->checkTerminated(ZZLcr4;Z)Z
    ...
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Ldr4;

    invoke-interface {v5, v9, v10}, Ldr4;->request(J)V
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v1, v1, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Ldr4;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, Ldr4;->request(J)V
...
.method public subscribe(Lcr4;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
