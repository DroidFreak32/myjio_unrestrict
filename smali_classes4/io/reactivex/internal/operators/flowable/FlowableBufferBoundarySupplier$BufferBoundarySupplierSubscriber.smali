...
# direct methods
.method public constructor <init>(Lcr4;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public bridge synthetic accept(Lcr4;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->accept(Lcr4;Ljava/util/Collection;)Z
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->upstream:Ldr4;
...
.method public next()V
    ...
    .line 10
    invoke-interface {v1, v2}, Lbr4;->subscribe(Lcr4;)V
    ...
    .line 15
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->upstream:Ldr4;

    invoke-interface {v1}, Ldr4;->cancel()V
...
.method public onSubscribe(Ldr4;)V
    ...
    .line 2
    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableBufferBoundarySupplier$BufferBoundarySupplierSubscriber;->upstream:Ldr4;
    ...
    .line 11
    invoke-interface {p1, v3, v4}, Ldr4;->request(J)V

    .line 12
    invoke-interface {v2, v1}, Lbr4;->subscribe(Lcr4;)V
    ...
    .line 16
    invoke-static {v2, v0}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lcr4;)V
