...
.method public static tryScalarXMapSubscribe(Lbr4;Lcr4;Lio/reactivex/functions/Function;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/subscriptions/ScalarSubscription;-><init>(Lcr4;Ljava/lang/Object;)V

    invoke-interface {p1, p2}, Lcr4;->onSubscribe(Ldr4;)V
    ...
    .line 10
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lcr4;)V

    return v0

    .line 11
    :cond_2
    invoke-interface {p0, p1}, Lbr4;->subscribe(Lcr4;)V
