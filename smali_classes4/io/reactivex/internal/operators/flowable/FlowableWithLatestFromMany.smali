...
.field public final otherArray:[Lbr4;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lbr4<",
...
.method public constructor <init>(Lio/reactivex/Flowable;Ljava/lang/Iterable;Lio/reactivex/functions/Function;)V
    ...
    .line 6
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lbr4;
...
.method public constructor <init>(Lio/reactivex/Flowable;[Lbr4;Lio/reactivex/functions/Function;)V
    .locals 0
    .param p1    # Lio/reactivex/Flowable;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lbr4;
...
.method public subscribeActual(Lcr4;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->otherArray:[Lbr4;
    ...
    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableMap;->subscribeActual(Lcr4;)V
    ...
    invoke-direct {v1, p1, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;-><init>(Lcr4;Lio/reactivex/functions/Function;I)V

    .line 11
    invoke-interface {p1, v1}, Lcr4;->onSubscribe(Ldr4;)V

    .line 12
    invoke-virtual {v1, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;->subscribe([Lbr4;I)V
