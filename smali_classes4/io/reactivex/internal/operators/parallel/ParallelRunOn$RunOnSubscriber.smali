...
# direct methods
.method public constructor <init>(Lcr4;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lcr4;
...
.method public onSubscribe(Ldr4;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Ldr4;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Ldr4;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lcr4;
...
.method public run()V
    ...
    .line 3
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lcr4;
    ...
    .line 11
    invoke-interface {v3, v15}, Lcr4;->onError(Ljava/lang/Throwable;)V
    ...
    .line 16
    :cond_6
    invoke-interface {v3, v15}, Lcr4;->onNext(Ljava/lang/Object;)V
    ...
    .line 17
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Ldr4;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Ldr4;->request(J)V
