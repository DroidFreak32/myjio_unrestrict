...
# virtual methods
.method public checkTerminated(ZZZLcr4;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lcr4;->onError(Ljava/lang/Throwable;)V
    ...
    .line 11
    :cond_2
    invoke-interface {p4}, Lcr4;->onComplete()V
...
.method public drain()V
    ...
    .line 4
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lcr4;)V

    goto :goto_1

    .line 5
    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lcr4;)V
...
.method public drainFused(Lcr4;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    :cond_2
    invoke-interface {p1, v4}, Lcr4;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lcr4;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLcr4;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 7
    invoke-interface {v5, v8}, Lcr4;->onNext(Ljava/lang/Object;)V
