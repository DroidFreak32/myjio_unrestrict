...
.method public constructor <init>(Laj3;Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/widget/TextView;ILandroid/widget/TextView;ILandroid/widget/TextView;)V
    ...
    iput-object p1, p0, Lqg3;->A:Laj3;

    iput-object p2, p0, Lqg3;->s:Landroid/view/View;

    iput-object p3, p0, Lqg3;->t:Landroid/view/View;

    iput-object p4, p0, Lqg3;->u:Landroid/view/View;

    iput-object p5, p0, Lqg3;->v:Landroid/widget/TextView;

    iput p6, p0, Lqg3;->w:I

    iput-object p7, p0, Lqg3;->x:Landroid/widget/TextView;

    iput p8, p0, Lqg3;->y:I

    iput-object p9, p0, Lqg3;->z:Landroid/widget/TextView;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lqg3;->s:Landroid/view/View;

    invoke-virtual {p1}, Landroid/view/View;->animate()Landroid/view/ViewPropertyAnimator;

    move-result-object p1

    iget-object v0, p0, Lqg3;->s:Landroid/view/View;
    ...
    iget-object p1, p0, Lqg3;->t:Landroid/view/View;

    invoke-virtual {p1}, Landroid/view/View;->animate()Landroid/view/ViewPropertyAnimator;

    move-result-object p1

    iget-object v0, p0, Lqg3;->t:Landroid/view/View;
    ...
    iget-object p1, p0, Lqg3;->u:Landroid/view/View;
    ...
    iget-object p1, p0, Lqg3;->v:Landroid/widget/TextView;

    iget v0, p0, Lqg3;->w:I

    invoke-virtual {p1, v0}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object p1, p0, Lqg3;->x:Landroid/widget/TextView;

    iget v0, p0, Lqg3;->y:I

    invoke-virtual {p1, v0}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object p1, p0, Lqg3;->z:Landroid/widget/TextView;

    iget v0, p0, Lqg3;->y:I

    invoke-virtual {p1, v0}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object p1, p0, Lqg3;->A:Laj3;
    ...
    const-string v3, "android:artist_detail:all_songs:date:view;"
