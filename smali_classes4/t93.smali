...
# direct methods
.method public constructor <init>(ZLk93$d;Landroid/content/Context;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lt93;->d:Z

    iput-boolean v0, p0, Lt93;->e:Z

    iput-boolean v0, p0, Lt93;->g:Z

    iput-boolean p1, p0, Lt93;->b:Z

    iput-object p2, p0, Lt93;->c:Lk93$d;

    iput-object p3, p0, Lt93;->f:Landroid/content/Context;

    return-void
.end method

.method public static synthetic a(Lt93;)Lk93$d;
    .locals 0

    iget-object p0, p0, Lt93;->c:Lk93$d;

    return-object p0
.end method

.method public static synthetic a(Lt93;Z)Z
    .locals 0
...
.method public static synthetic b(Lt93;)Z
    .locals 0

    iget-boolean p0, p0, Lt93;->b:Z

    return p0
.end method

.method public static synthetic c(Lt93;)Lcom/vmax/android/ads/api/b;
    .locals 0

    iget-object p0, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;
...
.method public a()V
    ...
    iput-object v0, p0, Lt93;->f:Landroid/content/Context;
...
.method public a(Landroid/webkit/WebView;)V
    ...
    invoke-direct {v0, p0}, Lt93$b;-><init>(Lt93;)V
...
.method public final a(Landroid/webkit/WebView;Landroid/net/Uri;)V
    ...
    :try_start_0
    iget-object v2, p0, Lt93;->f:Landroid/content/Context;
    ...
    :goto_1
    iget-object p1, p0, Lt93;->f:Landroid/content/Context;
    ...
    iget-object p1, p0, Lt93;->c:Lk93$d;

    if-eqz p1, :cond_2

    iget-object p1, p0, Lt93;->c:Lk93$d;

    invoke-interface {p1}, Lk93$d;->c()V

    :cond_2
    iget-object p1, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;
    ...
    invoke-virtual {p1}, Lcom/vmax/android/ads/api/b;->g()V
    ...
    :goto_2
    invoke-virtual {v2, p1, p2}, Lw3;->a(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    iget-object p2, p0, Lt93;->c:Lk93$d;

    if-eqz p2, :cond_c

    iget-object p2, p0, Lt93;->c:Lk93$d;

    invoke-interface {p2}, Lk93$d;->c()V

    :cond_c
    iget-object p2, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;
    ...
    invoke-virtual {p0, p1, p2}, Lt93;->b(Landroid/webkit/WebView;Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lt93;->f:Landroid/content/Context;
...
.method public a(Lk93;)V
    ...
    iput-object p1, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;
...
.method public final b(Landroid/webkit/WebView;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-boolean v3, p0, Lt93;->b:Z

    const/4 v4, 0x1

    if-nez v3, :cond_10

    iget-object v3, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;

    invoke-virtual {v3}, Lcom/vmax/android/ads/api/b;->j()Ljava/util/List;
    ...
    :try_start_1
    iget-object v5, p0, Lt93;->a:Lcom/vmax/android/ads/api/b;

    invoke-virtual {v5}, Lcom/vmax/android/ads/api/b;->j()Ljava/util/List;

    move-result-object v5

    invoke-virtual {v3, v5}, Le93;->a(Ljava/util/List;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    new-instance v0, Lt93$d;

    invoke-direct {v0, p0, p2}, Lt93$d;-><init>(Lt93;Ljava/lang/String;)V

    invoke-virtual {p1, p2, v4, v0}, Lcom/vmax/android/ads/api/b;->a(Ljava/lang/String;ZLr93;)V
    ...
    invoke-virtual {v3}, Lf93;->b()Ljava/lang/String;
    ...
    iget-object v7, p0, Lt93;->f:Landroid/content/Context;
    ...
    iget-object v1, p0, Lt93;->f:Landroid/content/Context;
    ...
    :cond_f
    invoke-virtual {p0, p1, v0}, Lt93;->a(Landroid/webkit/WebView;Landroid/net/Uri;)V
...
.method public onPageFinished(Landroid/webkit/WebView;Ljava/lang/String;)V
    ...
    new-instance p2, Lt93$c;

    invoke-direct {p2, p0}, Lt93$c;-><init>(Lt93;)V
...
.method public onPageStarted(Landroid/webkit/WebView;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    new-instance p2, Lt93$a;

    invoke-direct {p2, p0}, Lt93$a;-><init>(Lt93;)V
    ...
    invoke-interface {p1}, Lk93$d;->a()V
...
.method public shouldOverrideUrlLoading(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;)Z
    ...
    :cond_0
    iput-boolean v4, p0, Lt93;->g:Z

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2}, Landroid/os/Handler;-><init>()V

    new-instance v3, Lt93$e;

    invoke-direct {v3, p0}, Lt93$e;-><init>(Lt93;)V
    ...
    invoke-virtual {p0, p1, v2}, Lt93;->b(Landroid/webkit/WebView;Ljava/lang/String;)Z
