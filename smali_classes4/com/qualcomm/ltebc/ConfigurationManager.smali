...
.field public static final PROV_PROP_FILE:Ljava/lang/String; = "ltebc_provisioningProperties.txt"

.field public static final TAG:Ljava/lang/String; = "LTE_CONFIG"


# instance fields
.field public mLogAbsLoction:Ljava/lang/String;

.field public mLogExtLocation:Ljava/lang/String;

.field public final mProperties:Ljava/util/Properties;

.field public mProvisioningFileMD5:Ljava/lang/String;

.field public final mProvisioningLocation:Ljava/util/List;
...
.field public final mProvisioningLocationAssets:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public final mProvisioningProperties:Ljava/util/Properties;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v8, v1, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningLocation:Ljava/util/List;
    ...
    iput-object v8, v1, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningLocationAssets:Ljava/util/List;
    ...
    const-string v10, "/msc/ltebc_config.txt"
    ...
    const-string v11, " ConfigurationManager () : LTEApplication.internalDataPath "
    ...
    const-string v10, "Ltebc"

    invoke-static {v10, v8}, Lcom/qualcomm/ltebc/connection/LtebcLog;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 12
    :try_start_0
    iget-object v10, v1, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningProperties:Ljava/util/Properties;
    ...
    invoke-virtual {v10, v6}, Ljava/util/Properties;->containsKey(Ljava/lang/Object;)Z
    ...
    .line 18
    iget-object v13, v1, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningLocationAssets:Ljava/util/List;
    ...
    invoke-virtual {v10, v5}, Ljava/util/Properties;->containsKey(Ljava/lang/Object;)Z
    ...
    .line 28
    iget-object v13, v1, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningLocation:Ljava/util/List;
    ...
    .line 33
    invoke-virtual {v4, v12, v11}, Ljava/lang/String;->split(Ljava/lang/String;I)[Ljava/lang/String;
    ...
    .line 36
    iget-object v10, v1, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningLocation:Ljava/util/List;
    ...
    const-string v10, " Provisioning Exception = "
    ...
    const-string v10, " Provisioning SecurityException = "
...
.method private copyDebugFile()V
    ...
    const-string v3, "copyDebugFile: debugFilePath = "
    ...
    const-string v3, "copyDebugFile: srcDebugFile = "
    ...
    .line 12
    invoke-virtual {p0, v0, v2}, Lcom/qualcomm/ltebc/ConfigurationManager;->copyFile(Ljava/io/File;Ljava/io/File;)V
...
.method private copyFilesFromAssets()Z
    ...
    .line 27
    :try_start_6
    invoke-direct {v1, v9, v5}, Lcom/qualcomm/ltebc/ConfigurationManager;->copyBufferedStream(Ljava/io/BufferedInputStream;Ljava/io/BufferedOutputStream;)V
    :try_end_6
...
.method private copyLogLevelsFile()V
    ...
    iget-object v1, p0, Lcom/qualcomm/ltebc/ConfigurationManager;->mProvisioningLocation:Ljava/util/List;
...
.method public compareAndCopyProvisioningFile(Z)Z
    ...
    const-string v5, "provisioning_params.xml not found, copy all other files from dir : "
