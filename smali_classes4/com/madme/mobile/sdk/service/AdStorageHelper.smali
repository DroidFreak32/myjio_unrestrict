...
.field public static final a:Ljava/lang/String; = "AdStorageHelper"
...
.field public static final h:Lcom/madme/mobile/sdk/service/AdStorageHelper;
...
.method private a(Landroid/content/Context;Ljava/util/List;Ljava/util/List;)V
    ...
    const-string v3, "sendTrackingEventForDeletedCdnCampaignRecords: Deleted cid: %d"
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v1, "surveyresponse"
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Landroid/database/Cursor;Lcom/madme/mobile/sdk/service/FailingRecordConverter;Ljava/util/List;)V
    ...
    .line 14
    invoke-interface {p3, v5, v6, v1, p4}, Lcom/madme/mobile/sdk/service/FailingRecordConverter;->onConvertFailingRecord(J[BLjava/util/List;)Z
    ...
    const-string p4, "getFailingRecords: Could not convert IDs %s"
    ...
    const-string p4, "failingdownload"

    aput-object p4, p3, v4

    const-string p4, "failureid"
    ...
    const-string p2, "DELETE FROM %s WHERE %s IN (%s)"
...
.method public addFailingRecord(Landroid/content/Context;[B)J
    .locals 7
...
.method public addSurveyResponse(Landroid/content/Context;Landroid/os/Bundle;)Z
    ...
    const-string v6, "responseuri"

    const-string v7, "responseUri"
...
.method public deleteExclusiveResources(Landroid/content/Context;J)Ljava/util/ArrayList;
    ...
    const-string v6, "%s=%d AND (%s=1 OR %s=1)"
...
.method public deleteExpiredUnusedResources(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    const-string v15, "UPDATE %s SET %s=%d WHERE %s=0 AND %s IS NULL AND (SELECT COUNT(%s) FROM %s WHERE %s.%s=%s.%s)=0"
    ...
    const-string v7, "UPDATE %s SET %s=null WHERE %s=0 AND %s IS NOT NULL AND (SELECT COUNT(%s) FROM %s WHERE %s.%s=%s.%s)>0"
    ...
    invoke-virtual {v5, v11, v9}, Lcom/madme/mobile/configuration/a;->a(Ljava/lang/String;I)I
    ...
    const-string v5, "%s IS NOT NULL AND (julianday()-julianday(datetime(%s/1000, \"unixepoch\")))>%d"
...
.method public getFailingRecords(Landroid/content/Context;Lcom/madme/mobile/sdk/service/FailingRecordConverter;ILjava/util/List;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-direct {p0, p1, v0, p2, p4}, Lcom/madme/mobile/sdk/service/AdStorageHelper;->a(Landroid/database/sqlite/SQLiteDatabase;Landroid/database/Cursor;Lcom/madme/mobile/sdk/service/FailingRecordConverter;Ljava/util/List;)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Lcom/madme/mobile/sdk/exception/DbOpenException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getFailingRecordsBeyondLimit(Landroid/content/Context;Lcom/madme/mobile/sdk/service/FailingRecordConverter;ILjava/util/List;)V
    ...
    const-string v4, "SELECT %s FROM %s ORDER BY ROWID DESC LIMIT -1 OFFSET %d"
...
.method public getFistCdnCampaignRecord(Landroid/content/Context;)Landroid/os/Bundle;
    ...
    .catch Lcom/madme/mobile/sdk/exception/DbOpenException; {:try_start_1 .. :try_end_1} :catch_4
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public getOldFailingRecords(Landroid/content/Context;Lcom/madme/mobile/sdk/service/FailingRecordConverter;Ljava/util/List;)V
    ...
    const-string v2, "SELECT %s FROM %s WHERE (julianday()-julianday(datetime(%s/1000, \"unixepoch\")))>%d"
...
.method public removeCdnCampaignRecord(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    const-string v1, "removeCdnCampaignRecord()"
    ...
    const-string v3, "removeCdnCampaignRecord(): id="
...
.method public removeCdnCampaignRecordByCids(Landroid/content/Context;Ljava/util/List;)V
    ...
    const-string v3, "removeCdnCampaignRecordByCids(): cid="
...
.method public removeFailingRecord(Landroid/content/Context;J)V
    ...
    const-string v1, "removeFailingRecord()"
...
.method public removeSurveyResponseRecord(Landroid/content/Context;Landroid/os/Bundle;Z)V
    ...
    const-string v1, "removeSurveyResponseRecord()"
    ...
    const-string v4, "removeSurveyResponseRecord(): all for surveyid="
    ...
    const-string v4, "removeSurveyResponseRecord(): responseid="
...
.method public removeTrackingRecord(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    const-string v1, "removeTrackingRecord()"
    ...
    const-string v3, "removeTrackingRecord(): id="
...
.method public setResourceRecordDownloadingState(Landroid/content/Context;Ljava/lang/String;ZJ)V
    ...
    :goto_1
    const-string p4, "setResourceRecordDownloadingState(): %s updated = %b to %b"
    ...
    const-string p2, "setResourceRecordDownloadingState(): could not update %s record"
...
.method public setResourceRecordHeaderSize(Landroid/content/Context;Ljava/lang/String;J)V
    ...
    :goto_0
    const-string v3, "setResourceRecordHeaderSize(): %s updated = %b to %d"
    ...
    const-string p2, "setResourceRecordHeaderSize(): could not update %s record"
