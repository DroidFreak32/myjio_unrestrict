...
# static fields
.field private static serviceConnector:Lcom/jio/media/library/player/network/WebServiceConnector;
...
.method public getConfig(Lcom/jio/media/library/player/network/INetworkResultListener;I)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/jio/media/library/player/network/WebServiceClient;->getRetrofitProd()Lretrofit2/Retrofit;
    ...
    .line 2
    invoke-interface {v0}, Lcom/jio/media/library/player/network/ApiInterface;->getConfig()Lretrofit2/Call;
...
.method public getLoginViaSubIdData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/jio/media/library/player/network/INetworkResultListener;I)V
    ...
    .line 6
    invoke-interface {v0, p1, p3, v1, p2}, Lcom/jio/media/library/player/network/ApiInterface;->loginViaSubIdResponse(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lokhttp3/RequestBody;)Lretrofit2/Call;
...
.method public getPlayBackRightData(Lcom/jio/media/library/player/network/INetworkResultListener;ILjava/lang/String;Ljava/lang/String;Lcom/jio/media/library/player/model/LoginData;)V
    ...
    .line 4
    invoke-interface {v0, p5, p4, p3}, Lcom/jio/media/library/player/network/ApiInterface;->getPlayBackRightData(Ljava/lang/String;Ljava/lang/String;Lokhttp3/RequestBody;)Lretrofit2/Call;
...
.method public getRefreshTokenData(Lcom/jio/media/library/player/network/INetworkResultListener;ILjava/lang/String;)V
    ...
    .line 2
    invoke-virtual {p0}, Lcom/jio/media/library/player/network/WebServiceClient;->getRetrofitSecure()Lretrofit2/Retrofit;
    ...
    .line 3
    invoke-interface {v0, p3}, Lcom/jio/media/library/player/network/ApiInterface;->refreshTokenResponse(Lokhttp3/RequestBody;)Lretrofit2/Call;
...
.method public bridge synthetic getRetrofitAnalytics()Lretrofit2/Retrofit;
    ...
    .line 1
    invoke-super {p0}, Lcom/jio/media/library/player/network/WebServiceClient;->getRetrofitAnalytics()Lretrofit2/Retrofit;
...
.method public getZlaLoginData(Lcom/jio/media/library/player/network/INetworkResultListener;ILandroid/content/Context;)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/jio/media/library/player/network/WebServiceClient;->getRetrofit()Lretrofit2/Retrofit;
    ...
    invoke-interface {v0, v1, v2, v3, p3}, Lcom/jio/media/library/player/network/ApiInterface;->zlaLoginResponse(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lretrofit2/Call;
...
.method public sendAnalyticsAPIForBegin(Lcom/jio/media/library/player/network/INetworkResultListener;ILjava/util/HashMap;)V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/jio/media/library/player/network/WebServiceConnector;->getRetrofitAnalytics()Lretrofit2/Retrofit;
    ...
    .line 5
    invoke-interface {v0, p3}, Lcom/jio/media/library/player/network/ApiInterface;->analyticsAPIForBegin(Lokhttp3/RequestBody;)Lretrofit2/Call;
...
.method public sendAnalyticsAPIForEnd(Lcom/jio/media/library/player/network/INetworkResultListener;ILjava/util/HashMap;)V
    ...
    .line 5
    invoke-interface {v0, p3}, Lcom/jio/media/library/player/network/ApiInterface;->analyticsAPIForEnd(Lokhttp3/RequestBody;)Lretrofit2/Call;
...
.method public sendEventForInternalAnalytics(Lcom/jio/media/library/player/network/INetworkResultListener;ILjava/util/HashMap;)V
    ...
    .line 5
    invoke-interface {v0, p3}, Lcom/jio/media/library/player/network/ApiInterface;->analyticsAPIForEvent(Lokhttp3/RequestBody;)Lretrofit2/Call;
