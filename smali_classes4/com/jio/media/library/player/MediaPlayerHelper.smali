...
# instance fields
.field private checkFreeze:Ljava/lang/Runnable;

.field private fullMode:Z

.field private imgVideoBack:Landroid/widget/ImageView;

.field private isAdMuted:Z

.field private isAdWasShown:Z

.field private isAutoPlayOn:Z

.field private isLiveStreamSupportEnabled:Z

.field private isPlayerPrepared:Z

.field private isRepeatModeOn:Z

.field private isResumePlayWhenReady:Z

.field private isThumbImageViewEnabled:Z

.field private isToPrepareOnResume:Z

.field private isVideoMuted:Z

.field private mBtnFullScreen:Landroid/widget/ImageView;

.field private mBtnMute:Landroid/widget/ImageView;

.field private mContext:Landroid/content/Context;

.field private mDataSourceFactory:Lcom/google/android/exoplayer2/upstream/DataSource$Factory;

.field private mExoPlayerListener:Lcom/jio/media/library/player/MediaPlayerListener;

.field private mExoPlayerView:Lcom/google/android/exoplayer2/ui/PlayerView;

.field private mExoThumbListener:Lcom/jio/media/library/player/MediaThumbListener;

.field private mImaAdsLoader:Lcom/google/android/exoplayer2/ext/ima/ImaAdsLoader;

.field private mLoadControl:Lcom/google/android/exoplayer2/DefaultLoadControl;

.field private mMediaAdListener:Lcom/jio/media/library/player/MediaAdsListener;
...
.field private mResumeWindow:I

.field private mSubTitlesUrls:Ljava/util/ArrayList;
...
.field private mTagUrl:Ljava/lang/String;

.field private mTempCurrentVolume:F

.field private mThumbImage:Landroid/widget/ImageView;

.field private mVideosUris:[Landroid/net/Uri;

.field private txtVideoName:Landroid/widget/TextView;


# direct methods
.method private constructor <init>(Landroid/content/Context;Lcom/google/android/exoplayer2/ui/PlayerView;)V
    .locals 2
    ...
    .line 11
    sget p1, Lcom/jio/media/library/player/R$id;->exo_buffering:I
...
.method private addProgressBar(I)V
    ...
    iput-object v2, p0, Lcom/jio/media/library/player/MediaPlayerHelper;->mProgressBar:Landroid/widget/ProgressBar;
    ...
    iget-object v3, p0, Lcom/jio/media/library/player/MediaPlayerHelper;->mContext:Landroid/content/Context;
    ...
    .line 4
    invoke-virtual {v2, v1}, Landroid/widget/ProgressBar;->setId(I)V
...
.method private createMediaSource()V
    ...
    .line 3
    :goto_0
    iget-object v4, p0, Lcom/jio/media/library/player/MediaPlayerHelper;->mVideosUris:[Landroid/net/Uri;
    ...
    invoke-direct {p0, v4}, Lcom/jio/media/library/player/MediaPlayerHelper;->buildMediaSource(Landroid/net/Uri;)Lcom/google/android/exoplayer2/source/MediaSource;
    ...
    :goto_1
    iget-object v5, p0, Lcom/jio/media/library/player/MediaPlayerHelper;->mSubTitlesUrls:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v4, v5}, Lcom/jio/media/library/player/MediaPlayerHelper;->addSubTitlesToMediaSource(Lcom/google/android/exoplayer2/source/MediaSource;Ljava/lang/String;)Lcom/google/android/exoplayer2/source/MediaSource;
