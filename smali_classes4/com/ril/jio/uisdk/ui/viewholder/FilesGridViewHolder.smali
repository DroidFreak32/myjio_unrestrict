...
# static fields
.field public static isMultiselect:Z = false


# instance fields
.field public final FILE_IMAGE_THRESHOLD:I

.field public flagUpdateAnimation:I
...
.field public mFileItemClickListener:Lcom/ril/jio/uisdk/stubs/IFileItemClickListener;
...
.field public mIconViewParams:Landroid/view/ViewGroup$LayoutParams;
...
.field public mStatusHook:Lcom/ril/jio/uisdk/stubs/SdkWrapperStub$FileStatusHook;

.field public final multiSelectedModeIDs:Ljava/util/HashMap;
...
.field public rotate:Landroid/view/animation/RotateAnimation;
...
.field public final selectedIds:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet<",
            "Ljava/lang/String;",
...
.method private bindViews(Landroid/view/View;)V
    ...
    sget v0, Lu53;->file_main_imageView:I
    ...
    sget v0, Lu53;->file_card_view_container_layout:I
    ...
    sget v0, Lu53;->file_name_additional_detail:I
    ...
    sget v0, Lu53;->part_file_iv_icon:I
    ...
    sget v0, Lu53;->selected_part_file_iv_icon:I
    ...
    sget v0, Lu53;->circular_progress_view:I
    ...
    sget v0, Lu53;->part_file_iv_more_option:I
    ...
    sget v0, Lu53;->grid_item_parent_view:I
    ...
    sget v0, Lu53;->selected_shadow:I
    ...
    sget v0, Lu53;->crib_layout_bottom:I
    ...
    sget v0, Lu53;->crib_layout_top:I
    ...
    sget v0, Lu53;->icon_more_option:I
...
.method private loadDefaultFileImage()V
    ...
    sget v1, Ls53;->ic_boardfeedicon:I
...
.method private loadLocalSnapShot(Landroid/widget/ImageView;Ljava/lang/String;)V
    ...
    sget p2, Ls53;->ic_boardfeedicon:I

    invoke-static {v6, p2}, Lx6;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private setSubTitle(Lcom/ril/jio/uisdk/client/frag/bean/UploadFile;)V
    ...
    sget v3, Lz53;->upload_status_cancelled:I
    ...
    sget v3, Lz53;->upload_status_complete:I
    ...
    sget v3, Lz53;->upload_status_error:I
    ...
    sget v3, Lz53;->upload_status_progress:I
    ...
    sget v3, Lz53;->upload_status_paused:I
    ...
    sget v3, Lz53;->upload_status_quota_full:I
    ...
    sget v3, Lz53;->upload_status_queued:I
    ...
    sget v1, Lz53;->user_quota_full_msg:I
...
.method public bind(Lcom/ril/jio/jiosdk/system/IFile;)V
    ...
    invoke-direct {p0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->attachHookToHelper()V
    ...
    invoke-direct {p0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->showMoreOption()V

    const/4 v0, 0x0

    iput v0, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->flagUpdateAnimation:I

    iget-object v1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileItemClickListener:Lcom/ril/jio/uisdk/stubs/IFileItemClickListener;

    const/4 v2, 0x1

    if-eqz v1, :cond_1

    invoke-interface {v1}, Lcom/ril/jio/uisdk/stubs/IFileItemClickListener;->getUIMode()Lcom/ril/jio/jiosdk/util/JioConstant$eUIMode;

    move-result-object v1

    sget-object v3, Lcom/ril/jio/jiosdk/util/JioConstant$eUIMode;->FILE_TEJ_VIEW:Lcom/ril/jio/jiosdk/util/JioConstant$eUIMode;

    if-ne v1, v3, :cond_1

    iget-object v1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mParentLayout:Landroid/widget/RelativeLayout;

    invoke-virtual {v1, v2}, Landroid/widget/RelativeLayout;->setEnabled(Z)V

    iget-object v1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileContainerLayout:Landroid/widget/FrameLayout;

    invoke-virtual {v1, v2}, Landroid/widget/FrameLayout;->setEnabled(Z)V

    :cond_1
    iget-object v1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconViewParams:Landroid/view/ViewGroup$LayoutParams;
    ...
    iput-object v1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconViewParams:Landroid/view/ViewGroup$LayoutParams;

    goto :goto_0

    :cond_2
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;
    ...
    invoke-interface {v3}, Lcom/ril/jio/jiosdk/system/IFile;->getTitle()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lcom/ril/jio/uisdk/client/frag/d/b;->mItem:Lcom/ril/jio/jiosdk/system/IFile;

    invoke-interface {v4}, Lcom/ril/jio/jiosdk/system/IFile;->getFileMimeType()Lcom/ril/jio/jiosdk/system/FileType;

    move-result-object v4

    sget-object v5, Lcom/ril/jio/jiosdk/system/FileType;->IMAGE:Lcom/ril/jio/jiosdk/system/FileType;
    ...
    sget-object v5, Lcom/ril/jio/jiosdk/system/FileType;->VIDEO:Lcom/ril/jio/jiosdk/system/FileType;
    ...
    :cond_3
    iget-object v4, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->subtitleView:Landroid/widget/TextView;
    ...
    :cond_4
    :goto_1
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->subtitleView:Landroid/widget/TextView;

    invoke-virtual {v3, v6}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    :goto_2
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileContainerLayout:Landroid/widget/FrameLayout;

    iget-object v4, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mActivity:Landroid/app/Activity;

    const v5, 0x106000b

    invoke-static {v4, v5}, Lcom/ril/jio/uisdk/util/UiSdkUtil;->a(Landroid/content/Context;I)I

    move-result v4

    invoke-virtual {v3, v4}, Landroid/widget/FrameLayout;->setBackgroundColor(I)V

    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mCircularProgressView:Lcom/ril/jio/uisdk/customui/CircularProgressView;

    invoke-virtual {v3}, Lcom/ril/jio/uisdk/customui/CircularProgressView;->getCancelButton()Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    move-result-object v3

    iput-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mProgressCancelButton:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;
    ...
    :cond_6
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->selectedFile:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    if-eqz v3, :cond_7

    invoke-virtual {v3, v4}, Landroid/widget/RelativeLayout;->setVisibility(I)V

    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->selectedFileShadow:Landroid/view/View;

    invoke-virtual {v3, v4}, Landroid/view/View;->setVisibility(I)V

    :cond_7
    sget v3, Lq53;->white:I

    invoke-virtual {p0, v3, v2}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->setTitleTextAndColor(IZ)V
    ...
    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    invoke-virtual {v7, v0}, Landroid/widget/RelativeLayout;->setVisibility(I)V

    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileMainImage:Landroid/widget/ImageView;

    invoke-virtual {v7, v4}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileMainImage:Landroid/widget/ImageView;

    invoke-static {v7, v5}, Lba;->a(Landroid/view/View;Ljava/lang/String;)V

    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    iget-object v8, p0, Lcom/ril/jio/uisdk/client/frag/d/b;->mItem:Lcom/ril/jio/jiosdk/system/IFile;

    invoke-interface {v8}, Lcom/ril/jio/jiosdk/system/IFile;->getId()Ljava/lang/String;

    move-result-object v8

    invoke-static {v7, v8}, Lba;->a(Landroid/view/View;Ljava/lang/String;)V

    invoke-interface {p1}, Lcom/ril/jio/jiosdk/system/IFile;->getFileMimeType()Lcom/ril/jio/jiosdk/system/FileType;

    move-result-object v7

    sget-object v8, Lcom/ril/jio/jiosdk/system/FileType;->IMAGE:Lcom/ril/jio/jiosdk/system/FileType;
    ...
    invoke-direct {p0, v7, v8}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->loadLocalSnapShot(Landroid/widget/ImageView;Ljava/lang/String;)V
    ...
    :cond_9
    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mCircularProgressView:Lcom/ril/jio/uisdk/customui/CircularProgressView;

    invoke-virtual {v7, v0}, Landroid/widget/RelativeLayout;->setVisibility(I)V

    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mCircularProgressView:Lcom/ril/jio/uisdk/customui/CircularProgressView;

    invoke-virtual {v7, v0}, Lcom/ril/jio/uisdk/customui/CircularProgressView;->setIconVisible(Z)V

    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mCircularProgressView:Lcom/ril/jio/uisdk/customui/CircularProgressView;

    invoke-virtual {v7, v3}, Lcom/ril/jio/uisdk/customui/CircularProgressView;->a(Lcom/ril/jio/uisdk/client/frag/bean/UploadFile;)V

    iget-object v7, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mProgressCancelButton:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    new-instance v8, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$2;

    invoke-direct {v8, p0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$2;-><init>(Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;)V

    invoke-virtual {v7, v8}, Landroid/widget/RelativeLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-direct {p0, v3}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->setSubTitle(Lcom/ril/jio/uisdk/client/frag/bean/UploadFile;)V
    ...
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileSizeTV:Landroid/widget/TextView;

    invoke-virtual {v3, v6}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileMoreOption:Landroid/widget/LinearLayout;

    const/4 v6, 0x4

    invoke-virtual {v3, v6}, Landroid/widget/LinearLayout;->setVisibility(I)V

    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mOfflineView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;
    ...
    sget v7, Lz53;->folder_item_count_singular:I
    ...
    sget v7, Lz53;->folder_item_count_plural:I
    ...
    invoke-interface {p1}, Lcom/ril/jio/jiosdk/system/IFile;->getFileSize()Ljava/lang/Long;
    ...
    invoke-static {v6, v7, v8}, Lcom/ril/jio/uisdk/util/UiSdkUtil;->a(Landroid/content/Context;J)Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->multiSelectedModeIDs:Ljava/util/HashMap;
    ...
    :goto_6
    invoke-direct {p0, p1}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->updateOfflineIcon(Lcom/ril/jio/jiosdk/system/IFile;)V

    sget-boolean v3, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->isMultiselect:Z
    ...
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mCribLayoutBottom:Landroid/widget/FrameLayout;
    ...
    sget v7, Ls53;->drawable_shadow_bottom:I
    ...
    iget-object v6, p0, Lcom/ril/jio/uisdk/client/frag/d/b;->mItem:Lcom/ril/jio/jiosdk/system/IFile;

    invoke-interface {v6}, Lcom/ril/jio/jiosdk/system/IFile;->getId()Ljava/lang/String;

    move-result-object v6

    invoke-static {v3, v6}, Lba;->a(Landroid/view/View;Ljava/lang/String;)V

    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    invoke-static {v3, v5}, Lba;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    sget-object v3, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$8;->$SwitchMap$com$ril$jio$jiosdk$system$FileType:[I
    ...
    sget v1, Ls53;->ic_file_icon_svg_other_rect:I
    ...
    invoke-direct {p0, p1, v2}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->downloadImage(Lcom/ril/jio/jiosdk/system/IFile;Z)V
    ...
    iget-object v6, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileMainImage:Landroid/widget/ImageView;

    sget-object v7, Landroid/widget/ImageView$ScaleType;->CENTER_CROP:Landroid/widget/ImageView$ScaleType;

    new-instance v8, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$4;

    invoke-direct {v8, p0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$4;-><init>(Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;)V

    iget-object v9, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mActivity:Landroid/app/Activity;

    iget-object p1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    invoke-virtual {p1}, Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;->getDrawable()Landroid/graphics/drawable/Drawable;
    ...
    invoke-static/range {v5 .. v13}, Lcom/ril/jio/uisdk/util/UiSdkUtil;->b(Ljava/lang/String;Landroid/widget/ImageView;Landroid/widget/ImageView$ScaleType;Lcom/bumptech/glide/request/RequestListener;Landroid/content/Context;ZLandroid/graphics/drawable/Drawable;ZZ)V
    ...
    :goto_8
    sget p1, Lq53;->typoOther:I

    invoke-virtual {p0, p1, v2}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->setTitleTextAndColor(IZ)V
    ...
    sget v5, Lz53;->icon_video:I

    invoke-virtual {v1, v5}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v3, v1}, Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;->setIconText(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    sget v3, Lq53;->iconSecondary:I

    invoke-virtual {v1, v3}, Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;->setIconColorRes(I)V
    ...
    new-instance v8, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$3;

    invoke-direct {v8, p0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$3;-><init>(Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;)V
    ...
    iget-object p1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mPreviewIconHolder:Landroid/view/View;

    invoke-virtual {p1, v0}, Landroid/view/View;->setVisibility(I)V

    iget-object p1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mPreviewIcon:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;
    ...
    iget-object v0, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    sget v3, Lz53;->icon_audio:I
    ...
    sget v1, Lq53;->iconSecondary:I

    invoke-virtual {v0, v1}, Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;->setIconColorRes(I)V
    ...
    sget v1, Ls53;->ic_file_icon_svg_xls_rect:I
    ...
    sget v1, Ls53;->ic_file_icon_svg_ppt_rect:I
    ...
    sget v1, Ls53;->ic_file_icon_svg_txt_rect:I
    ...
    sget v1, Ls53;->ic_file_icon_svg_doc_rect:I
    ...
    sget v1, Ls53;->ic_file_icon_svg_pdf_rect:I
    ...
    sget v3, Lr53;->icon_dimension_80:I
    ...
    iget-object v3, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mActivity:Landroid/app/Activity;

    invoke-virtual {v3}, Landroid/app/Activity;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Lr53;->icon_dimension_80:I
    ...
    iget-object v2, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    invoke-virtual {v2, p1}, Landroid/widget/RelativeLayout;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    sget v2, Lz53;->icon_folder_with_sync:I
    ...
    sget v1, Lq53;->transparent:I

    invoke-virtual {p1, v1}, Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;->setIconColorBackgroundRes(I)V
    ...
    invoke-static {p1, v1}, Lba;->a(Landroid/view/View;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mIconView:Lcom/ril/jio/uisdk/customui/fonticon/ShapeFontButton;

    invoke-static {p1, v5}, Lba;->a(Landroid/view/View;Ljava/lang/String;)V

    :goto_c
    sget p1, Lq53;->typoPrimary:I

    invoke-virtual {p0, p1, v0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->setTitleTextAndColor(IZ)V

    :goto_d
    iget-object p1, p0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;->mFileMoreOption:Landroid/widget/LinearLayout;

    new-instance v0, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$5;

    invoke-direct {v0, p0}, Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder$5;-><init>(Lcom/ril/jio/uisdk/ui/viewholder/FilesGridViewHolder;)V
...
.method public setTitleTextAndColor(IZ)V
    ...
    sget v2, Ls53;->drawable_shadow_top:I
    ...
    sget v1, Ls53;->drawable_shadow_bottom:I
    ...
    sget v0, Lq53;->typoOther:I

    goto :goto_2

    :cond_5
    sget v0, Lq53;->typoPrimary:I
    ...
    sget p2, Lq53;->typoOther:I

    goto :goto_4

    :cond_9
    sget p2, Lq53;->typoPrimary:I
