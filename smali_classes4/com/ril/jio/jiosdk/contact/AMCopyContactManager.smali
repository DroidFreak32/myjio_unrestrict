...
# static fields
.field public static final TAG:Ljava/lang/String; = "AMCopyContactManager"


# instance fields
.field public accounts:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.field public alreadyContactPresentCount:I

.field public code:I

.field public contactCopiedCount:I

.field public mAddedContactAccountExisting:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/CopyOnWriteArrayList<",
...
.field public mAddedContacts:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/CopyOnWriteArrayList<",
            "Lcom/ril/jio/jiosdk/contact/Contact;",
...
.field public mAllContactsFromMetadata:Ljava/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public mContactMapList:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field public final mDbController:Lcom/ril/jio/jiosdk/database/IDBController;

.field public final mHttpManager:Lcom/ril/jio/jiosdk/http/IHttpManager;

.field public mIgnoredContactList:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/CopyOnWriteArrayList<",
            "Lcom/ril/jio/jiosdk/contact/Contact;",
...
.field public mIsCopyAPIInProgress:Z

.field public mIsFromRestore:Z
...
.field public mModifiedContacts:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/CopyOnWriteArrayList<",
            "Lcom/ril/jio/jiosdk/contact/Contact;",
...
.field public mNativeAddressBookManager:Lcom/ril/jio/jiosdk/contact/copy/NativeAddressBookManager;
...
.method public constructor <init>(Landroid/content/Context;Lcom/ril/jio/jiosdk/database/IDBController;Lcom/ril/jio/jiosdk/http/IHttpManager;)V
    ...
    .line 10
    new-instance p2, Lcom/ril/jio/jiosdk/contact/copy/NativeAddressBookManager;

    iget-object p3, p0, Lcom/ril/jio/jiosdk/contact/AMCopyContactManager;->mDbController:Lcom/ril/jio/jiosdk/database/IDBController;

    invoke-direct {p2, p1, p3}, Lcom/ril/jio/jiosdk/contact/copy/NativeAddressBookManager;-><init>(Landroid/content/Context;Lcom/ril/jio/jiosdk/database/IDBController;)V

    iput-object p2, p0, Lcom/ril/jio/jiosdk/contact/AMCopyContactManager;->mNativeAddressBookManager:Lcom/ril/jio/jiosdk/contact/copy/NativeAddressBookManager;
...
.method private startProcessCopyContacts(Landroid/os/ResultReceiver;)V
    ...
    .line 6
    :goto_1
    invoke-direct {p0, v2}, Lcom/ril/jio/jiosdk/contact/AMCopyContactManager;->changeCopyState(Z)V
    ...
    .line 8
    iget v2, p0, Lcom/ril/jio/jiosdk/contact/AMCopyContactManager;->code:I
...
.method public contactCopiedToNativeAPI()V
    ...
    invoke-virtual {p0, v1}, Lcom/ril/jio/jiosdk/contact/AMCopyContactManager;->getNativeCopyCallback(Lorg/json/JSONObject;)Lno$d1;

    move-result-object v1

    invoke-interface {v2, v3, v4, v1}, Lcom/ril/jio/jiosdk/http/IHttpManager;->amikoAsyncOperations(Lcom/ril/jio/jiosdk/contact/RequestType;Ljava/lang/String;Lno$d1;)V
...
.method public getNativeCopyCallback(Lorg/json/JSONObject;)Lno$d1;
    .locals 1
