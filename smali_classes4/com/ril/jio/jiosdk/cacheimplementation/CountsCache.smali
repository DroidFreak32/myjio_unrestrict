...
.field public b:Lio/reactivex/subjects/BehaviorSubject;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/subjects/BehaviorSubject<",
            "Lcom/ril/jio/jiosdk/cacheimplementation/CountsCache$CountInfo;",
...
.method private c()V
    ...
    const-string v1, "refreshFixedFileListFromMap: "
...
.method public refreshCabCount()V
    ...
    const-string v2, "refreshCabCount: "
...
.method public refreshFixedFileCountsForMime(Ljava/util/HashSet;)V
    ...
    const-string v1, "refreshFixedFileCountsForMime: "
