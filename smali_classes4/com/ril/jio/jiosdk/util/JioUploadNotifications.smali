...
.field public static sInstance:Lcom/ril/jio/jiosdk/util/JioUploadNotifications;

.field public static sJioUploadQueueMap:Ljava/util/concurrent/ConcurrentHashMap;
...
# instance fields
.field public currAllFilesProgress:D

.field public isFileUploadsComplete:Z
...
.method private getPendingIntent(ZLcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Lcom/ril/jio/jiosdk/system/SdkEvents$EventsStatus;)Landroid/app/PendingIntent;
    ...
    const-string v4, "IS_FROM_ANDROID_O"
    ...
    .line 8
    iget-object v3, p2, Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;->mObjectType:Ljava/lang/String;
    ...
    :goto_1
    const-string v4, "board_or_folder_id"
    ...
    invoke-static {p3, p1, v0, p2}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method private updateProgressStatus(ZLq6$d;I)V
    .locals 9
    ...
    .line 8
    invoke-virtual {p2, v1, v0, v2}, Lq6$d;->a(IIZ)Lq6$d;
    ...
    .line 20
    :goto_4
    invoke-virtual {p2, p1}, Lq6$d;->b(Ljava/lang/CharSequence;)Lq6$d;

    .line 21
    invoke-virtual {p2, v0}, Lq6$d;->a(Ljava/lang/CharSequence;)Lq6$d;

    const-string p1, "com.ril.jio.jiosdk.util.LocalNotificationManger"

    .line 22
    invoke-virtual {p2, p1}, Lq6$d;->a(Ljava/lang/String;)Lq6$d;
    ...
    invoke-virtual {p2, v0, v1}, Lq6$d;->a(J)Lq6$d;
...
.method public onUploadCancelled(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;)V
    ...
    .line 2
    sget-object v0, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->sBuilder:Lq6$d;
    ...
    .line 9
    :cond_3
    sget-object p1, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->sBuilder:Lq6$d;

    invoke-direct {p0, v0, p1, v1}, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->updateProgressStatus(ZLq6$d;I)V

    .line 10
    :goto_0
    sget-object p1, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->sBuilder:Lq6$d;

    invoke-virtual {p1, v0}, Lq6$d;->d(Z)Lq6$d;
    :try_end_0
...
.method public onUploadCompleted(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Lcom/ril/jio/jiosdk/system/JioFile;)V
    ...
    invoke-direct {p2, v2, v1}, Lq6$d;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 9
    invoke-virtual {p2, v1}, Lq6$d;->a(Ljava/lang/String;)Lq6$d;
    ...
    invoke-virtual {p2, v1}, Lq6$d;->b(Ljava/lang/CharSequence;)Lq6$d;
    ...
    .line 13
    invoke-virtual {p2, v1}, Lq6$d;->a(Z)Lq6$d;

    const/4 v2, 0x0

    .line 14
    invoke-virtual {p2, v2}, Lq6$d;->d(Z)Lq6$d;
    ...
    invoke-virtual {p2, v3, v4}, Lq6$d;->a(J)Lq6$d;
    ...
    invoke-virtual {p2, p1}, Lq6$d;->a(Landroid/app/PendingIntent;)Lq6$d;
...
.method public onUploadError(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Lcom/ril/jio/jiosdk/system/SdkEvents$EventsStatus;)V
    ...
    invoke-direct {v2, v3, v0}, Lq6$d;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    .line 7
    invoke-virtual {v2, v0}, Lq6$d;->a(Ljava/lang/String;)Lq6$d;
    ...
    invoke-virtual {v2, v0}, Lq6$d;->f(I)Lq6$d;
    ...
    invoke-virtual {v2, v0}, Lq6$d;->b(Ljava/lang/CharSequence;)Lq6$d;

    const-string v0, "Tap here for details"

    .line 10
    invoke-virtual {v2, v0}, Lq6$d;->a(Ljava/lang/CharSequence;)Lq6$d;

    const/4 v0, 0x1

    .line 11
    invoke-virtual {v2, v0}, Lq6$d;->a(Z)Lq6$d;
    ...
    invoke-virtual {v2, v3, v4}, Lq6$d;->a(J)Lq6$d;
    ...
    invoke-virtual {v2, p1}, Lq6$d;->a(Landroid/app/PendingIntent;)Lq6$d;
...
.method public onUploadPaused()V
    ...
    .line 4
    sget-object v1, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->sBuilder:Lq6$d;

    const/16 v2, 0x2ce

    invoke-direct {p0, v0, v1, v2}, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->updateProgressStatus(ZLq6$d;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onUploadProgress(Ljava/lang/Long;Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;)V
    ...
    invoke-virtual {p1, v0}, Lq6$d;->b(I)Lq6$d;
    ...
    invoke-direct {p0, v1, p1, p2}, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->updateProgressStatus(ZLq6$d;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onUploadQueued(Lcom/ril/jio/jiosdk/system/ISdkEventInterface$UploadDataPacket;Ljava/lang/Long;)V
    ...
    invoke-direct {p1, p2, v0}, Lq6$d;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object p1, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->sBuilder:Lq6$d;

    .line 14
    sget-object p1, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->sBuilder:Lq6$d;

    invoke-virtual {p1, v0}, Lq6$d;->a(Ljava/lang/String;)Lq6$d;
    ...
    invoke-virtual {p1, p2}, Lq6$d;->a(Ljava/lang/CharSequence;)Lq6$d;
    ...
    invoke-virtual {p1, p2}, Lq6$d;->f(I)Lq6$d;
    ...
    invoke-virtual {p1, p2}, Lq6$d;->d(Z)Lq6$d;
    ...
    invoke-virtual {p1, v0, v1}, Lq6$d;->a(J)Lq6$d;
    ...
    invoke-virtual {p1, p2}, Lq6$d;->b(I)Lq6$d;
    ...
    invoke-direct {p0, v2, p1, p2}, Lcom/ril/jio/jiosdk/util/JioUploadNotifications;->updateProgressStatus(ZLq6$d;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onUploadQueued(Ljava/util/List;)V
    ...
    invoke-direct {p1, v1, v0}, Lq6$d;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lq6$d;->a(Ljava/lang/CharSequence;)Lq6$d;
