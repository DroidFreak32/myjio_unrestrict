...
.field public static a:J = 0x4d3f6400L
...
.method public static a(Landroid/content/Context;Lcom/ril/jio/jiosdk/system/JioUser$AppPrioritySettings;)Z
    .locals 2
...
.method public static fillBackupSettings(Landroid/content/Context;Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    .line 7
    :cond_0
    invoke-static {v1}, Lcom/ril/jio/jiosdk/autobackup/core/Util;->isCameraSelected(Ljava/util/List;)Z
    ...
    .line 12
    :goto_2
    sget-object v8, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->BACKUP_CAMERA_HIGH_QUALITY:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;

    invoke-virtual {p1, v8}, Ljava/util/concurrent/ConcurrentHashMap;->containsKey(Ljava/lang/Object;)Z

    move-result v8

    const-string v10, "photoQuality"
    ...
    :goto_3
    const-string v8, "No backup folders"

    const-string v10, "No folder selected"

    const-string v11, ""

    if-eqz v2, :cond_5

    const-string v1, "photoFolderBackup"
    ...
    invoke-static {v2, v1, v9}, Lcom/ril/jio/jiosdk/autobackup/core/Util;->getBackupFolderNames(Ljava/lang/String;Ljava/util/List;Z)Ljava/lang/String;
    ...
    :cond_7
    const-string v2, "photoFolderBackup"
    ...
    .line 20
    sget-object v2, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->BACKUP_VIDEO:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;

    invoke-virtual {p1, v2}, Ljava/util/concurrent/ConcurrentHashMap;->containsKey(Ljava/lang/Object;)Z

    move-result v2

    const-string/jumbo v12, "videoBackup"
    ...
    const-string/jumbo v1, "videoFolderBackup"
    ...
    :cond_e
    const-string/jumbo v2, "videoFolderBackup"
    ...
    invoke-static {v4, v1, v9}, Lcom/ril/jio/jiosdk/autobackup/core/Util;->getBackupFolderNames(Ljava/lang/String;Ljava/util/List;Z)Ljava/lang/String;
    ...
    :cond_11
    const-string v4, "audioFolderBackup"
    ...
    const-string v1, "documentBackup"
    ...
    invoke-static {v1, p2, v9}, Lcom/ril/jio/jiosdk/autobackup/core/Util;->getBackupFolderNames(Ljava/lang/String;Ljava/util/List;Z)Ljava/lang/String;
    ...
    :cond_14
    const-string v1, "documentFolderBackup"

    .line 46
    invoke-virtual {v0, v1, p2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 47
    sget-object p2, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->CONTACTS_AUTO_BACKUP_ON_OFF_SWITCH_SETTINGS:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    .line 50
    :goto_a
    sget-object p2, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->BACKUP_MESSAGES:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    const-string p2, "backgroundUploading"
    ...
    .line 56
    :goto_c
    sget-object p2, Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;->BACKUP_NETWORK_SETTING:Lcom/ril/jio/jiosdk/util/JioConstant$AppSettings;
    ...
    const-string p1, "contactPermission"
    ...
    const-string/jumbo p1, "storagePermission"
    ...
    const-string p1, "messagePermission"
    ...
    const-string p0, "phoneStatePermission"
