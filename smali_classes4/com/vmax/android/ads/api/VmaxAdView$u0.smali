...
.method public onAttachSuccess(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p1}, Lcom/vmax/android/ads/api/NativeAd;->b()V
    ...
    invoke-static {p1, v0}, Lcom/vmax/android/ads/api/VmaxAdView;->a(Lcom/vmax/android/ads/api/VmaxAdView;Lcom/vmax/android/ads/api/VmaxAdView$AdViewState;)Lcom/vmax/android/ads/api/VmaxAdView$AdViewState;

    iget-object p1, p0, Lcom/vmax/android/ads/api/VmaxAdView$u0;->a:Lcom/vmax/android/ads/api/VmaxAdView;

    invoke-static {p1}, Lcom/vmax/android/ads/api/VmaxAdView;->q0(Lcom/vmax/android/ads/api/VmaxAdView;)V

    iget-object p1, p0, Lcom/vmax/android/ads/api/VmaxAdView$u0;->a:Lcom/vmax/android/ads/api/VmaxAdView;

    iget-object p1, p1, Lcom/vmax/android/ads/api/VmaxAdView;->M:Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/vmax/android/ads/api/VmaxAdView;->r0(Lcom/vmax/android/ads/api/VmaxAdView;)Lorg/json/JSONObject;
    ...
    iget-object v0, p1, Lcom/vmax/android/ads/api/VmaxAdView;->M:Ljava/lang/String;

    invoke-static {p1}, Lcom/vmax/android/ads/api/VmaxAdView;->r0(Lcom/vmax/android/ads/api/VmaxAdView;)Lorg/json/JSONObject;

    move-result-object v1

    invoke-static {p1, v0, v1}, Lcom/vmax/android/ads/api/VmaxAdView;->a(Lcom/vmax/android/ads/api/VmaxAdView;Ljava/lang/String;Lorg/json/JSONObject;)V

    :cond_2
    iget-object p1, p0, Lcom/vmax/android/ads/api/VmaxAdView$u0;->a:Lcom/vmax/android/ads/api/VmaxAdView;

    invoke-static {p1}, Lcom/vmax/android/ads/api/VmaxAdView;->m(Lcom/vmax/android/ads/api/VmaxAdView;)Z
    ...
    invoke-static {p1}, Lcom/vmax/android/ads/api/VmaxAdView;->n(Lcom/vmax/android/ads/api/VmaxAdView;)Landroid/widget/RelativeLayout;
    ...
    invoke-virtual {p1, p1}, Lcom/vmax/android/ads/api/VmaxAdView;->a(Landroid/view/View;)V
