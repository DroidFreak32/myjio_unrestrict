...
.method public constructor <init>(Lcc3;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcc3$n;->t:Lcc3;

    iput-object p2, p0, Lcc3$n;->s:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v0, p0, Lcc3$n;->t:Lcc3;

    iget-object v0, v0, Lsm3;->u:Landroid/app/Activity;

    if-eqz v0, :cond_0

    new-instance v1, Lcc3$n$a;

    invoke-direct {v1, p0}, Lcc3$n$a;-><init>(Lcc3$n;)V
    ...
    iget-object v1, p0, Lcc3$n;->s:Ljava/lang/String;
