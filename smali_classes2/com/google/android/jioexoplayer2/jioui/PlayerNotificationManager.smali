...
.field public final customActionReceiver:Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$CustomActionReceiver;
...
.field public final mediaDescriptionAdapter:Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$MediaDescriptionAdapter;

.field public mediaSessionToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;

.field public final notificationBroadcastReceiver:Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$NotificationBroadcastReceiver;

.field public final notificationId:I

.field public notificationListener:Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$NotificationListener;

.field public final notificationManager:Lt6;
...
.field public final playerListener:Lcom/google/android/jioexoplayer2/Player$EventListener;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;ILcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$MediaDescriptionAdapter;Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$CustomActionReceiver;)V
    ...
    iput-object p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->mainHandler:Landroid/os/Handler;

    .line 11
    invoke-static {p1}, Lt6;->a(Landroid/content/Context;)Lt6;

    move-result-object p2

    iput-object p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->notificationManager:Lt6;

    .line 12
    new-instance p2, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$PlayerListener;

    const/4 p3, 0x0

    invoke-direct {p2, p0, p3}, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$PlayerListener;-><init>(Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$1;)V

    iput-object p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->playerListener:Lcom/google/android/jioexoplayer2/Player$EventListener;

    .line 13
    new-instance p2, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$NotificationBroadcastReceiver;

    invoke-direct {p2, p0}, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$NotificationBroadcastReceiver;-><init>(Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;)V

    iput-object p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->notificationBroadcastReceiver:Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager$NotificationBroadcastReceiver;
    ...
    iput-object p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->intentFilter:Landroid/content/IntentFilter;

    const/4 p2, 0x1

    .line 15
    iput-boolean p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->useNavigationActions:Z

    .line 16
    iput-boolean p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->usePlayPauseActions:Z

    .line 17
    iput-boolean p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->ongoing:Z

    .line 18
    iput-boolean p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->colorized:Z

    .line 19
    iput-boolean p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->useChronometer:Z

    const/4 p3, 0x0

    .line 20
    iput p3, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->color:I

    .line 21
    sget p4, Lcom/app/cinemasdk/R$drawable;->exo_notification_small_icon:I

    iput p4, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->smallIconResourceId:I

    .line 22
    iput p3, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->defaults:I

    const/4 p3, -0x1

    .line 23
    iput p3, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->priority:I

    const-wide/16 p3, 0x3a98

    .line 24
    iput-wide p3, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->fastForwardMs:J

    const-wide/16 p3, 0x1388

    .line 25
    iput-wide p3, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->rewindMs:J

    const-string p3, "com.google.android.exoplayer.stop"

    .line 26
    iput-object p3, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->stopAction:Ljava/lang/String;

    .line 27
    iput p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->badgeIconType:I

    .line 28
    iput p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->visibility:I
    ...
    .line 30
    iget-object p2, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->playbackActions:Ljava/util/Map;
    ...
    .line 35
    iget-object p1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->customActions:Ljava/util/Map;
    ...
    .line 36
    iget-object p4, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->intentFilter:Landroid/content/IntentFilter;
    ...
    iget-object p1, p1, Lq6$a;->i:Landroid/app/PendingIntent;
...
.method public static createPlaybackActions(Landroid/content/Context;I)Ljava/util/Map;
    ...
    invoke-direct {v1, v2, v3, v5}, Lq6$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v1, v2, v3, p0}, Lq6$a;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
...
.method private stopNotification()V
    ...
    .line 2
    iget-object v0, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->notificationManager:Lt6;

    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->notificationId:I

    invoke-virtual {v0, v1}, Lt6;->a(I)V
...
.method private updateNotification(Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    invoke-virtual {v0, v1, p1}, Lt6;->a(ILandroid/app/Notification;)V
...
.method public createNotification(Lcom/google/android/jioexoplayer2/Player;Landroid/graphics/Bitmap;)Landroid/app/Notification;
    ...
    .line 9
    invoke-virtual {v0, v4}, Lq6$d;->a(Lq6$a;)Lq6$d;
    ...
    .line 12
    invoke-virtual {v3, v4}, Ljf;->a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Ljf;
    ...
    invoke-virtual {v3, v1}, Ljf;->a([I)Ljf;
    ...
    .line 15
    :goto_2
    invoke-virtual {v3, v1}, Ljf;->a(Z)Ljf;
    ...
    invoke-virtual {v3, v1}, Ljf;->a(Landroid/app/PendingIntent;)Ljf;

    .line 19
    :cond_5
    invoke-virtual {v0, v3}, Lq6$d;->a(Lq6$g;)Lq6$d;

    .line 20
    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->badgeIconType:I

    .line 21
    invoke-virtual {v0, v1}, Lq6$d;->a(I)Lq6$d;

    iget-boolean v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->ongoing:Z

    .line 22
    invoke-virtual {v0, v1}, Lq6$d;->d(Z)Lq6$d;

    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->color:I

    .line 23
    invoke-virtual {v0, v1}, Lq6$d;->b(I)Lq6$d;

    iget-boolean v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->colorized:Z

    .line 24
    invoke-virtual {v0, v1}, Lq6$d;->b(Z)Lq6$d;

    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->smallIconResourceId:I

    .line 25
    invoke-virtual {v0, v1}, Lq6$d;->f(I)Lq6$d;

    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->visibility:I

    .line 26
    invoke-virtual {v0, v1}, Lq6$d;->g(I)Lq6$d;

    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->priority:I

    .line 27
    invoke-virtual {v0, v1}, Lq6$d;->e(I)Lq6$d;

    iget v1, p0, Lcom/google/android/jioexoplayer2/jioui/PlayerNotificationManager;->defaults:I
    ...
    .line 35
    invoke-virtual {v0, v4}, Lq6$d;->e(Z)Lq6$d;

    .line 36
    invoke-virtual {v0, v4}, Lq6$d;->f(Z)Lq6$d;
    ...
    invoke-virtual {v0, v2}, Lq6$d;->f(Z)Lq6$d;
    ...
    invoke-virtual {v0, v1}, Lq6$d;->c(Ljava/lang/CharSequence;)Lq6$d;
    ...
    .line 43
    invoke-virtual {v0, p2}, Lq6$d;->b(Landroid/graphics/Bitmap;)Lq6$d;
