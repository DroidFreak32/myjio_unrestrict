...
.field public final manifest:Lcom/google/android/jioexoplayer2/source/jiodash/manifest/DashManifest;
...
.method private getAdjustedWindowDefaultStartPositionUs(J)J
    ...
    iget-boolean v2, v2, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/DashManifest;->dynamic:Z
    ...
    .line 6
    :goto_0
    iget-object p2, p0, Lcom/google/android/jioexoplayer2/source/jiodash/DashMediaSource$DashTimeline;->manifest:Lcom/google/android/jioexoplayer2/source/jiodash/manifest/DashManifest;

    invoke-virtual {p2}, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/DashManifest;->getPeriodCount()I
    ...
    invoke-virtual {p2, p1}, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/DashManifest;->getPeriodDurationUs(I)J
    ...
    .line 9
    invoke-virtual {p2, p1}, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/DashManifest;->getPeriod(I)Lcom/google/android/jioexoplayer2/source/jiodash/manifest/Period;
    ...
    .line 10
    invoke-virtual {p1, p2}, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/Period;->getAdaptationSetIndex(I)I
    ...
    check-cast p1, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/AdaptationSet;

    iget-object p1, p1, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/AdaptationSet;->representations:Ljava/util/List;
    ...
    check-cast p1, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/Representation;

    invoke-virtual {p1}, Lcom/google/android/jioexoplayer2/source/jiodash/manifest/Representation;->getIndex()Lcom/google/android/jioexoplayer2/source/jiodash/DashSegmentIndex;
    ...
    .line 13
    invoke-interface {p1, v6, v7}, Lcom/google/android/jioexoplayer2/source/jiodash/DashSegmentIndex;->getSegmentCount(J)I
    ...
    .line 14
    :cond_4
    invoke-interface {p1, v4, v5, v6, v7}, Lcom/google/android/jioexoplayer2/source/jiodash/DashSegmentIndex;->getSegmentNum(JJ)J

    move-result-wide v2

    .line 15
    invoke-interface {p1, v2, v3}, Lcom/google/android/jioexoplayer2/source/jiodash/DashSegmentIndex;->getTimeUs(J)J
