...
# static fields
.field private static final GOOGLE_PAY_IN_APP_LOG_TAG:Ljava/lang/String; = "GooglePayInApp"

.field private static final GOOGLE_PAY_LOAD_PAYMENT_ACTION:Ljava/lang/String; = "com.google.android.apps.nbu.paisa.user.LOAD_PAYMENT_DATA"

.field private static final GOOGLE_PAY_SDK_SERVICE:Ljava/lang/String; = "com.google.android.apps.nbu.paisa.user.inapp.sdk.service.IS_READY_TO_PAY"


# instance fields
.field private googlePayPackageInfo:Lcom/google/android/apps/nbu/paisa/inapp/client/api/GooglePayPackageInfo;
...
.method public isReadyToPay(Landroid/content/Context;Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 2
    invoke-virtual {p0, p1, v2}, Lcom/google/android/apps/nbu/paisa/inapp/client/api/PaymentsClient;->isGooglePayInstalled(Landroid/content/Context;I)Z
    ...
    invoke-direct {v3, v1, p2, p1}, Lcom/google/android/apps/nbu/paisa/inapp/client/api/PaymentsClient$IsReadyToPayServiceConnection;-><init>(Lcom/google/android/gms/tasks/TaskCompletionSource;Ljava/lang/String;Landroid/content/Context;)V

    const/4 p2, 0x1

    .line 9
    :try_start_0
    invoke-virtual {p1, v2, v3, p2}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
