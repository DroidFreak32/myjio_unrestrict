...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus$NamespaceStatusVerifier;
    }
.end annotation
...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    const-string v3, "NO_TEMPLATE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;->NO_TEMPLATE:Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    .line 3
    new-instance v3, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    const-string v5, "NO_CHANGE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;->NO_CHANGE:Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    .line 4
    new-instance v5, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    const-string v7, "EMPTY_CONFIG"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8, v8}, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;->EMPTY_CONFIG:Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    .line 5
    new-instance v7, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    const-string v9, "NOT_AUTHORIZED"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10, v10}, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;->NOT_AUTHORIZED:Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;
    ...
    .line 6
    sput-object v9, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;->$VALUES:[Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus;
...
.method public static internalGetVerifier()Lcom/google/protobuf/Internal$EnumVerifier;
    ...
    .line 1
    sget-object v0, Lcom/google/android/gms/config/proto/Config$AppNamespaceConfigTable$NamespaceStatus$NamespaceStatusVerifier;->INSTANCE:Lcom/google/protobuf/Internal$EnumVerifier;
