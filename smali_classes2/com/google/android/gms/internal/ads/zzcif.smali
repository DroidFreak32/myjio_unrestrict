...
.field private zzgiu:Landroid/widget/PopupWindow;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
# virtual methods
.method public final zzapd()V
    .locals 3

    .line 1
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/zzcif;->context:Landroid/content/Context;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lcom/google/android/gms/internal/ads/zzcif;->zzgiu:Landroid/widget/PopupWindow;
    ...
    .line 3
    iput-object v2, p0, Lcom/google/android/gms/internal/ads/zzcif;->context:Landroid/content/Context;

    .line 4
    iput-object v2, p0, Lcom/google/android/gms/internal/ads/zzcif;->zzgiu:Landroid/widget/PopupWindow;

    return-void

    .line 5
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/zzcif;->zzgiu:Landroid/widget/PopupWindow;
...
.method public final zzc(Landroid/content/Context;Landroid/view/View;)V
    ...
    .line 2
    :cond_0
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/ads/zzcif;->zzd(Landroid/content/Context;Landroid/view/View;)Landroid/widget/PopupWindow;

    move-result-object p2

    iput-object p2, p0, Lcom/google/android/gms/internal/ads/zzcif;->zzgiu:Landroid/widget/PopupWindow;
    ...
    .line 3
    :goto_0
    iput-object p1, p0, Lcom/google/android/gms/internal/ads/zzcif;->context:Landroid/content/Context;
